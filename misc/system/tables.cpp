...
const struct flag_type affect2_flags[] = // some false to implemented?
{
	...
	{ "etheral",			AFF2_ETHEREAL,		true	},
	{ "shadowplane",		AFF2_SHADOWPLANE,	true	},
	...
	{ "stone_gargoyle",		AFF2_STONE_GARGOYLE,		false	}, // place holder
 	{ "bountyhunter",		AFF2_BOUNTYHUNTER,		false	},
 	{ "despair",			AFF2_DESPAIR,			false	},
 	{ "dragonform",			AFF2_DRAGONFORM,		false	},
   { "shapeshift",			AFF2_SHAPESHIFT,		false	},
	{  NULL,	 0,  0	 }
};

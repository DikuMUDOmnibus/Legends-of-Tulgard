...
dynlookup_type dynlookup_table[]={
	...
	{ "mining",					DYNTYPE_SKILL, &gsn_mining },
	...
	{ "bow",                    DYNTYPE_SKILL, &gsn_bow },
	{ "blowgun",                DYNTYPE_SKILL, &gsn_blowgun },
	{ "sling",                  DYNTYPE_SKILL, &gsn_sling },
	...
	{ "werewolf",           	DYNTYPE_SKILL, &gsn_werewolf },
	{ "abyssal",            	DYNTYPE_SKILL, &gsn_abyssal },
	{ "aquan",              	DYNTYPE_SKILL, &gsn_aquan },
	{ "auran",             		DYNTYPE_SKILL, &gsn_auran },
	{ "celestial",             	DYNTYPE_SKILL, &gsn_celestial },
	{ "common",             	DYNTYPE_SKILL, &gsn_common },
	{ "draconic",             	DYNTYPE_SKILL, &gsn_draconic },
	{ "dwarven",             	DYNTYPE_SKILL, &gsn_dwarven },
	{ "elven",             		DYNTYPE_SKILL, &gsn_elven },
	{ "giant",             		DYNTYPE_SKILL, &gsn_giant },
	...
	{ "ignan",             		DYNTYPE_SKILL, &gsn_ignan },
	{ "orcish",             	DYNTYPE_SKILL, &gsn_orcish },
	{ "sylvan",             	DYNTYPE_SKILL, &gsn_sylvan },
	{ "terran",             	DYNTYPE_SKILL, &gsn_terran },
	{ "undercommon",             	DYNTYPE_SKILL, &gsn_undercommon },

	// Ixliam Extras
 	{ "blade permanance",       DYNTYPE_SPELL, &gsn_blade_permanance },
 	{ "despair",                DYNTYPE_SPELL, &gsn_despair },
 	{ "hallucinate",            DYNTYPE_SPELL, &gsn_hallucinate },
 	{ "power word stun",        DYNTYPE_SPELL, &gsn_power_word_stun },
 	{ "power word kill",        DYNTYPE_SPELL, &gsn_power_word_kill },
 	{ "remort",                 DYNTYPE_SPELL, &gsn_remort },
 	{ "beholder",               DYNTYPE_SPELL, &gsn_beholder },
 	{ "vampire",         	    DYNTYPE_SPELL, &gsn_vampire },
 	{ "lycanthrope",       	    DYNTYPE_SPELL, &gsn_werewolf },
 	{ "tail",                   DYNTYPE_SKILL, &gsn_tail },
 	{ "hunt",                   DYNTYPE_SKILL, &gsn_hunt },
 	{ "crush",                  DYNTYPE_SKILL, &gsn_crush },
 	{ "wolf call",              DYNTYPE_SKILL, &gsn_wolf_call },
 	{ "triune wield",	    DYNTYPE_SKILL, &gsn_triwield },
 	{ "quad wield",		    DYNTYPE_SKILL, &gsn_quadwield },
 	{ "shapechange",       	    DYNTYPE_SPELL, &gsn_shapechange },
	{ "wish power",       	    DYNTYPE_SPELL, &gsn_wishes },
	{ "harmonize",              DYNTYPE_SPELL, &gsn_harmonize },
	{ "turn undead",            DYNTYPE_SPELL, &gsn_turn_undead },
	{ "animate dead",           DYNTYPE_SPELL, &gsn_animate_dead },
	{ "destroy cursed",         DYNTYPE_SPELL, &gsn_destroy_cursed },
	{ "summon undead",          DYNTYPE_SPELL, &gsn_summon_undead },
	{ "mass plague",            DYNTYPE_SPELL, &gsn_mass_plague },
	{ "polymorph",              DYNTYPE_SPELL, &gsn_polymorph },
	{ "firestorm",              DYNTYPE_SPELL, &gsn_firestorm },
	{ "decay magic",            DYNTYPE_SPELL, &gsn_decay_magic },
	{ "enchantment of roots",   DYNTYPE_SPELL, &gsn_enchantment_roots },
 	{ "weaponsmith",            DYNTYPE_SKILL, &gsn_weaponsmith },
 	{ "armorsmith",             DYNTYPE_SKILL, &gsn_armorsmith },
	{ "dark vision",            DYNTYPE_SPELL, &gsn_darkvision },
	{ "mark rune",              DYNTYPE_SPELL, &gsn_mark_rune },
	{ "invoke rune",            DYNTYPE_SPELL, &gsn_invoke_rune },
	{ "bardic visions",         DYNTYPE_SPELL, &gsn_bardic_visions },
	{ "bardic peace",           DYNTYPE_SPELL, &gsn_bardic_peace },
	{ "enhanced healing",       DYNTYPE_SPELL, &gsn_enhanced_healing },
	{ "summon light",           DYNTYPE_SPELL, &gsn_summon_light },
	{ "kill magic",             DYNTYPE_SPELL, &gsn_kill_magic },
	{ "sobriety",               DYNTYPE_SPELL, &gsn_sober_drunks },
	{ "fog of truth",           DYNTYPE_SPELL, &gsn_fog_of_truth },
	{ "battle rage",            DYNTYPE_SPELL, &gsn_battle_rage },
	{ "create sustinance",      DYNTYPE_SPELL, &gsn_create_sustinance },
	{ "sleepytime",             DYNTYPE_SPELL, &gsn_sleepytime },
	{ "natures howl",           DYNTYPE_SPELL, &gsn_natures_howl },
	{ "dreamscape",             DYNTYPE_SPELL, &gsn_dreamscape },
	{ "cupcake breath",         DYNTYPE_SPELL, &gsn_cupcake_breath },
 	{ "leathercraft",           DYNTYPE_SKILL, &gsn_leathercraft },
 	{ "fletcher",               DYNTYPE_SKILL, &gsn_fletcher },
	{ "spiritual champion",		DYNTYPE_SPELL, &gsn_spiritual_champion },
	{ "scorpion claw",			DYNTYPE_SPELL, &gsn_scorpion_claw },
	{ "conceal",				DYNTYPE_SKILL, &gsn_conceal },
	{ "light bonding",			DYNTYPE_SPELL, &gsn_light_bonding },
	{ "bonding",				DYNTYPE_SPELL, &gsn_bonding },
	{ "heavy bonding",			DYNTYPE_SPELL, &gsn_heavy_bonding },
	{ "destroy living",			DYNTYPE_SPELL, &gsn_destroy_living },
	{ "heavy withering",		DYNTYPE_SPELL, &gsn_heavy_withering},
	{ "withering",				DYNTYPE_SPELL, &gsn_withering },
	{ "light withering",		DYNTYPE_SPELL, &gsn_light_withering },
	{ "gust",					DYNTYPE_SPELL, &gsn_gust },
	{ "spinblock",				DYNTYPE_SKILL, &gsn_spinblock },
	{ "orbit",					DYNTYPE_SKILL, &gsn_orbit },
	{ "grant life",				DYNTYPE_SPELL, &gsn_grant_life },
	{ "sanctify",				DYNTYPE_SPELL, &gsn_sanctify },
	{ "consecrate",				DYNTYPE_SPELL, &gsn_consecrate },
	{ "blight",					DYNTYPE_SPELL, &gsn_blight },
	{ "suffocate",				DYNTYPE_SPELL, &gsn_suffocate },
	{ "chicanery",				DYNTYPE_SKILL, &gsn_chicanery },
	{ "bluff",					DYNTYPE_SKILL, &gsn_bluff },
	{ "wyldfire",				DYNTYPE_SPELL, &gsn_wyldfire },
	{ "morbid rememberance",	DYNTYPE_SPELL, &gsn_morbid_rememberance },
	{ "cadaver strength",		DYNTYPE_SPELL, &gsn_cadaver_strength },
	{ "necrotic barrier",		DYNTYPE_SPELL, &gsn_necrotic_barrier },
	{ "bloodshield",			DYNTYPE_SPELL, &gsn_blood_shield },
	{ "firearms",				DYNTYPE_SKILL, &gsn_firearms },
	{ "rearkick",				DYNTYPE_SKILL, &gsn_rearkick },	
	{ "raging fever",           DYNTYPE_SPELL, &gsn_raging_fever },
	{ "second wind",            DYNTYPE_SPELL, &gsn_second_wind },
	{ "tinker",            DYNTYPE_SKILL, &gsn_tinker },
	{ "reinforce",            DYNTYPE_SKILL, &gsn_reinforce },
	{ "occultism",            DYNTYPE_SKILL, &gsn_occultism },
	{ "necrotism",            DYNTYPE_SKILL, &gsn_necrotism },
	{ "survival",		  DYNTYPE_SKILL, &gsn_survival },
	{ "hiking",		  DYNTYPE_SKILL, &gsn_hiking },
	{ "earth affinity",	DYNTYPE_SKILL, &gsn_earth_affinity },
	{ "water affinity",	DYNTYPE_SKILL, &gsn_water_affinity },
	{ "air affinity",	DYNTYPE_SKILL, &gsn_air_affinity },
	{ "fire affinity",	DYNTYPE_SKILL, &gsn_fire_affinity },
	{ "wall of stone",            DYNTYPE_SPELL, &gsn_wall_of_stone },
	{ "wall of thorns",            DYNTYPE_SPELL, &gsn_wall_of_thorns },
	{ "hold person",            DYNTYPE_SPELL, &gsn_hold_person },
	{ "evasion",			DYNTYPE_SKILL, &gsn_evasion },
	{ "acrobatics",			DYNTYPE_SKILL, &gsn_acrobatics },
	{ "rotten odor",            	DYNTYPE_SPELL, &gsn_smell_rotten },
	{ "rose odor",            	DYNTYPE_SPELL, &gsn_smell_rose },
	{ "jasmine odor",            	DYNTYPE_SPELL, &gsn_smell_jasmine },
	{ "sewage odor",            	DYNTYPE_SPELL, &gsn_smell_sewer },
	{ "soap odor",            	DYNTYPE_SPELL, &gsn_smell_soap },
	{ "cinnamon odor",            	DYNTYPE_SPELL, &gsn_smell_cinnamon },
	{ "corpse odor",            	DYNTYPE_SPELL, &gsn_smell_corpse },
	{ "rotten food odor",           DYNTYPE_SPELL, &gsn_smell_rotfood },
	{ "bread odor",            	DYNTYPE_SPELL, &gsn_smell_freshbread },
	{ "hay odor",            	DYNTYPE_SPELL, &gsn_smell_mownhay },
	{ "linen odor",            	DYNTYPE_SPELL, &gsn_smell_freshlinen },
	{ "incense odor",            	DYNTYPE_SPELL, &gsn_smell_incense },
	{ "smoke odor",            	DYNTYPE_SPELL, &gsn_smell_smoke },
};
...
dynspell_type spellpairs_table[]={
	...
	{ SPFUNC_NODAMTYPE, "spell_blight", spell_blight, TAR_CHAR_DEFENSIVE},	
	...
	{ SPFUNC_NODAMTYPE, "spell_bonding", spell_bonding, TAR_CHAR_DEFENSIVE},
	...
	{ SPFUNC_NODAMTYPE, "spell_consecrate", spell_consecrate, TAR_OBJ_INV},
	...
	{ SPFUNC_DAMTYPE, "spell_destroy_living", spell_destroy_living, TAR_CHAR_OFFENSIVE}, //Reath
	...
	{ SPFUNC_NODAMTYPE, "spell_grant_life", spell_grant_life, TAR_OBJ_INV},	
	{ SPFUNC_DAMTYPE, "spell_gust", spell_gust, TAR_IGNORE},
	...
	{ SPFUNC_NODAMTYPE, "spell_heavy_bonding", spell_heavy_bonding, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_DAMTYPE, "spell_heavy_withering", spell_heavy_withering, TAR_CHAR_OFFENSIVE}, //Reath
	...
	{ SPFUNC_NODAMTYPE, "spell_light_bonding", spell_light_bonding, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_DAMTYPE, "spell_lions_roar", spell_lions_roar, TAR_CHAR_OFFENSIVE},
	...
	{ SPFUNC_DAMTYPE, "spell_light_withering", spell_light_withering, TAR_CHAR_OFFENSIVE}, //Reath
  ...
  { SPFUNC_NOTEXT|SPFUNC_DAMTYPE, "spell_sb_magic_missile", spell_sb_magic_missile, TAR_CHAR_OFFENSIVE}, //Meerclar
	...
	{ SPFUNC_NODAMTYPE, "spell_sanctify", spell_sanctify, TAR_OBJ_INV},
	{ SPFUNC_NODAMTYPE, "spell_sanctuary", spell_sanctuary, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_DAMTYPE, "spell_scorpion_claw", spell_scorpion_claw, TAR_CHAR_OFFENSIVE}, //Reath
	...
	{ SPFUNC_NODAMTYPE, "spell_spiritual_champion", spell_spiritual_champion, TAR_CHAR_SELF},	
	...
	{ SPFUNC_NODAMTYPE, "spell_wall_of_fire", spell_wall_of_fire, TAR_DIRECTION },
	{ SPFUNC_NODAMTYPE, "spell_wall_of_ice", spell_wall_of_ice, TAR_DIRECTION },
	...
	{ SPFUNC_DAMTYPE, "spell_withering", spell_withering, TAR_CHAR_OFFENSIVE}, //Reath
	...
	// Ixliam Extras	
 	...
 	{ SPFUNC_NODAMTYPE, "spell_blade_permanance", spell_blade_permanance, TAR_OBJ_INV},
 	{ SPFUNC_DAMTYPE, "spell_despair", spell_despair, TAR_MOB_OFFENSIVE},
 	{ SPFUNC_DAMTYPE, "spell_hallucinate", spell_hallucinate, TAR_MOB_OFFENSIVE},
 	{ SPFUNC_DAMTYPE, "spell_power_word_stun", spell_power_word_stun, TAR_MOB_OFFENSIVE},
 	{ SPFUNC_DAMTYPE, "spell_power_word_kill", spell_power_word_kill, TAR_MOB_OFFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_harmonize", spell_harmonize, TAR_OBJ_INV},
	{ SPFUNC_NODAMTYPE, "spell_animate_dead", spell_animate_dead, TAR_IGNORE},
	{ SPFUNC_DAMTYPE, "spell_turn_undead", spell_turn_undead, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_destroy_cursed", spell_destroy_cursed, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_summon_undead", spell_summon_undead, TAR_IGNORE},
	{ SPFUNC_DAMTYPE, "spell_mass_plague", spell_mass_plague, TAR_CHAR_OFFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_polymorph", spell_polymorph, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_DAMTYPE, "spell_firestorm", spell_firestorm, TAR_CHAR_OFFENSIVE},
	{ SPFUNC_DAMTYPE, "spell_decay_magic", spell_decay_magic, TAR_OBJ_CHAR_OFF},
	{ SPFUNC_NODAMTYPE, "spell_enchantment_roots", spell_enchantment_roots, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_darkvision", spell_darkvision, TAR_CHAR_DEFENSIVE},
 	{ SPFUNC_NODAMTYPE, "spell_mark_rune", spell_mark_rune, TAR_OBJ_INV},
 	{ SPFUNC_NODAMTYPE, "spell_invoke_rune", spell_invoke_rune, TAR_OBJ_INV},
 	{ SPFUNC_DAMTYPE, "spell_bardic_visions", spell_bardic_visions, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_bardic_peace", spell_bardic_peace, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_enhanced_healing", spell_enhanced_healing, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_summon_light", spell_summon_light, TAR_IGNORE},
	{ SPFUNC_NODAMTYPE, "spell_kill_magic", spell_kill_magic, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_sober_drunks", spell_sober_drunks, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_fog_of_truth", spell_fog_of_truth, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_battle_rage", spell_battle_rage, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_create_sustinance", spell_create_sustinance, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_sleepytime", spell_sleepytime, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_natures_howl", spell_natures_howl, TAR_IGNORE},
	{ SPFUNC_NODAMTYPE, "spell_dreamscape", spell_dreamscape, TAR_CHAR_SELF},
	{ SPFUNC_DAMTYPE, "spell_cupcake_breath", spell_cupcake_breath, TAR_CHAR_OFFENSIVE},
	{ SPFUNC_DAMTYPE, "spell_wyldfire", spell_wyldfire, TAR_CHAR_OFFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_morbid_rememberance", spell_morbid_rememberance, TAR_OBJ_INV},
	{ SPFUNC_NODAMTYPE, "spell_necrotic_barrier", spell_necrotic_barrier, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_cadaver_strength", spell_cadaver_strength, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_blood_shield", spell_blood_shield, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_second_wind", spell_second_wind, TAR_CHAR_DEFENSIVE},
	{ SPFUNC_NODAMTYPE, "spell_wall_of_stone", spell_wall_of_stone, TAR_DIRECTION },
	{ SPFUNC_NODAMTYPE, "spell_wall_of_thorns", spell_wall_of_thorns, TAR_DIRECTION },
	{ SPFUNC_NODAMTYPE, "spell_hold_person", spell_hold_person, TAR_CHAR_OFFENSIVE },
	{ SPFUNC_NODAMTYPE, "spell_rotten_odor", spell_rotten_odor, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_rose_odor", spell_rose_odor, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_jasmine_odor", spell_jasmine_odor, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_sewage_odor", spell_sewage_odor, TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_soap_odor",spell_soap_odor , TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_cinnamon_odor",spell_cinnamon_odor , TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_corpse_odor",spell_corpse_odor , TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_rotten_food_odor",spell_rotten_food odor , TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_bread_odor",spell_bread_odor , TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_hay_odor",spell_hay_odor , TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_linen_odor",spell_linen_odor , TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_incense_odor",spell_incense_odor , TAR_CHAR_SELF},
	{ SPFUNC_NODAMTYPE, "spell_smoke_odor",spell_smoke_odor , TAR_CHAR_SELF}, 

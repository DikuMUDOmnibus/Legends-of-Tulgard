...
const struct flag_type race_flags[] =
{
	...
	{ "telepathy",		RACEFLAG_TELEPATHY,true},	
	{ "can_werebeast",	RACEFLAG_CAN_WEREBEAST, true},
	{ "can_vampire",	RACEFLAG_CAN_VAMPIRE, true},
	{ NULL,0,0}
};
...
GIO_INT(food_vnum)
GIO_WFLAG(terr_restrict, terr_restrict_flags)

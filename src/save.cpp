...
void	revert_race		args( ( char_data *ch) );
...
void fwrite_char( char_data *ch, FILE *fp )
{
	...
	fprintf( fp, "Gnosis %d\n",		ch->gnosis);
	fprintf( fp, "Werecircle %d\n",	ch->werecircle);
 	fprintf( fp, "Pregnant %ld\n",(long) ch->pcdata->pregnant);
    ...
    // Bard Song Rewrites - format is song number, line number
     if (!IS_NULLSTR(ch->s1_0))
	fprintf( fp, "Song1_0 %s~\n",	ch->s1_0);
     if (!IS_NULLSTR(ch->s1_1))
	fprintf( fp, "Song1_1 %s~\n",	ch->s1_1);
     if (!IS_NULLSTR(ch->s1_2))
	fprintf( fp, "Song1_2 %s~\n",	ch->s1_2);
     if (!IS_NULLSTR(ch->s1_3))
	fprintf( fp, "Song1_3 %s~\n",	ch->s1_3);
     if (!IS_NULLSTR(ch->s1_4))
	fprintf( fp, "Song1_4 %s~\n",	ch->s1_4);
     if (!IS_NULLSTR(ch->s1_5))
	fprintf( fp, "Song1_5 %s~\n",	ch->s1_5);
     if (!IS_NULLSTR(ch->s1_6))
	fprintf( fp, "Song1_6 %s~\n",	ch->s1_6);
     if (!IS_NULLSTR(ch->s1_7))
	fprintf( fp, "Song1_7 %s~\n",	ch->s1_7);

     if (!IS_NULLSTR(ch->s2_0))
	fprintf( fp, "Song2_0 %s~\n",	ch->s2_0);
     if (!IS_NULLSTR(ch->s2_1))
	fprintf( fp, "Song2_1 %s~\n",	ch->s3_1);
     if (!IS_NULLSTR(ch->s2_2))
	fprintf( fp, "Song2_2 %s~\n",	ch->s2_2);
     if (!IS_NULLSTR(ch->s2_3))
	fprintf( fp, "Song2_3 %s~\n",	ch->s2_3);
     if (!IS_NULLSTR(ch->s2_4))
	fprintf( fp, "Song2_4 %s~\n",	ch->s2_4);
     if (!IS_NULLSTR(ch->s2_5))
	fprintf( fp, "Song2_5 %s~\n",	ch->s2_5);
     if (!IS_NULLSTR(ch->s2_6))
	fprintf( fp, "Song2_6 %s~\n",	ch->s2_6);
     if (!IS_NULLSTR(ch->s2_7))
	fprintf( fp, "Song2_7 %s~\n",	ch->s2_7);

     if (!IS_NULLSTR(ch->s3_0))
	fprintf( fp, "Song3_0 %s~\n",	ch->s3_0);
     if (!IS_NULLSTR(ch->s3_1))
	fprintf( fp, "Song3_1 %s~\n",	ch->s3_1);
     if (!IS_NULLSTR(ch->s3_2))
	fprintf( fp, "Song3_2 %s~\n",	ch->s3_2);
     if (!IS_NULLSTR(ch->s3_3))
	fprintf( fp, "Song3_3 %s~\n",	ch->s3_3);
     if (!IS_NULLSTR(ch->s3_4))
	fprintf( fp, "Song3_4 %s~\n",	ch->s3_4);
     if (!IS_NULLSTR(ch->s3_5))
	fprintf( fp, "Song3_5 %s~\n",	ch->s3_5);
     if (!IS_NULLSTR(ch->s3_6))
	fprintf( fp, "Song3_6 %s~\n",	ch->s3_6);
     if (!IS_NULLSTR(ch->s3_7))
	fprintf( fp, "Song3_7 %s~\n",	ch->s3_7);
     if (!IS_NULLSTR(ch->s3_8))
	fprintf( fp, "Song3_8 %s~\n",	ch->s3_8);
     if (!IS_NULLSTR(ch->s3_9))
	fprintf( fp, "Song3_9 %s~\n",	ch->s3_9);
     if (!IS_NULLSTR(ch->s3_10))
	fprintf( fp, "Song3_10 %s~\n",	ch->s3_10);
     if (!IS_NULLSTR(ch->s3_11))
	fprintf( fp, "Song3_11 %s~\n",	ch->s3_11);

     if (!IS_NULLSTR(ch->s4_0))
	fprintf( fp, "Song4_0 %s~\n",	ch->s4_0);
     if (!IS_NULLSTR(ch->s4_1))
	fprintf( fp, "Song4_1 %s~\n",	ch->s4_1);
     if (!IS_NULLSTR(ch->s4_2))
	fprintf( fp, "Song4_2 %s~\n",	ch->s4_2);
     if (!IS_NULLSTR(ch->s4_3))
	fprintf( fp, "Song4_3 %s~\n",	ch->s4_3);

     if (!IS_NULLSTR(ch->s5_0))
	fprintf( fp, "Song5_0 %s~\n",	ch->s5_0);
     if (!IS_NULLSTR(ch->s5_1))
	fprintf( fp, "Song5_1 %s~\n",	ch->s5_1);
     if (!IS_NULLSTR(ch->s5_2))
	fprintf( fp, "Song5_2 %s~\n",	ch->s5_2);
     if (!IS_NULLSTR(ch->s5_3))
	fprintf( fp, "Song5_3 %s~\n",	ch->s5_3);
     if (!IS_NULLSTR(ch->s5_4))
	fprintf( fp, "Song5_4 %s~\n",	ch->s5_4);

     if (!IS_NULLSTR(ch->s6_0))
	fprintf( fp, "Song6_0 %s~\n",	ch->s6_0);
     if (!IS_NULLSTR(ch->s6_1))
	fprintf( fp, "Song6_1 %s~\n",	ch->s6_1);
     if (!IS_NULLSTR(ch->s6_2))
	fprintf( fp, "Song6_2 %s~\n",	ch->s6_2);
     if (!IS_NULLSTR(ch->s6_3))
	fprintf( fp, "Song6_3 %s~\n",	ch->s6_3);
     if (!IS_NULLSTR(ch->s6_4))
	fprintf( fp, "Song6_4 %s~\n",	ch->s6_4);
     if (!IS_NULLSTR(ch->s6_5))
	fprintf( fp, "Song6_5 %s~\n",	ch->s6_5);

     if (!IS_NULLSTR(ch->s7_0))
	fprintf( fp, "Song7_0 %s~\n",	ch->s7_0);
     if (!IS_NULLSTR(ch->s7_1))
	fprintf( fp, "Song7_1 %s~\n",	ch->s7_1);
     if (!IS_NULLSTR(ch->s7_2))
	fprintf( fp, "Song7_2 %s~\n",	ch->s7_2);
     if (!IS_NULLSTR(ch->s7_3))
	fprintf( fp, "Song7_3 %s~\n",	ch->s7_3);
     if (!IS_NULLSTR(ch->s7_4))
	fprintf( fp, "Song7_4 %s~\n",	ch->s7_4);
     if (!IS_NULLSTR(ch->s7_5))
	fprintf( fp, "Song7_5 %s~\n",	ch->s7_5);

     if (!IS_NULLSTR(ch->s8_0))
	fprintf( fp, "Song8_0 %s~\n",	ch->s8_0);
     if (!IS_NULLSTR(ch->s8_1))
	fprintf( fp, "Song8_1 %s~\n",	ch->s8_1);
     if (!IS_NULLSTR(ch->s8_2))
	fprintf( fp, "Song8_2 %s~\n",	ch->s8_2);
     if (!IS_NULLSTR(ch->s8_3))
	fprintf( fp, "Song8_3 %s~\n",	ch->s8_3);
     if (!IS_NULLSTR(ch->s8_4))
	fprintf( fp, "Song8_4 %s~\n",	ch->s8_4);
     if (!IS_NULLSTR(ch->s8_5))
	fprintf( fp, "Song8_5 %s~\n",	ch->s8_5);
     if (!IS_NULLSTR(ch->s8_6))
	fprintf( fp, "Song8_6 %s~\n",	ch->s8_6);
     if (!IS_NULLSTR(ch->s8_7))
	fprintf( fp, "Song8_7 %s~\n",	ch->s8_7);
     if (!IS_NULLSTR(ch->s8_8))
	fprintf( fp, "Song8_8 %s~\n",	ch->s8_8);
     if (!IS_NULLSTR(ch->s8_9))
	fprintf( fp, "Song8_9 %s~\n",	ch->s8_9);
     if (!IS_NULLSTR(ch->s8_10))
	fprintf( fp, "Song8_10 %s~\n",	ch->s8_10);
     if (!IS_NULLSTR(ch->s8_11))
	fprintf( fp, "Song8_11 %s~\n",	ch->s8_11);
     if (!IS_NULLSTR(ch->s8_12))
	fprintf( fp, "Song8_12 %s~\n",	ch->s8_12);
     if (!IS_NULLSTR(ch->s8_13))
	fprintf( fp, "Song8_13 %s~\n",	ch->s8_13);
     if (!IS_NULLSTR(ch->s8_14))
	fprintf( fp, "Song8_14 %s~\n",	ch->s8_14);
     if (!IS_NULLSTR(ch->s8_15))
	fprintf( fp, "Song8_15 %s~\n",	ch->s8_15);
     if (!IS_NULLSTR(ch->s8_16))
	fprintf( fp, "Song8_16 %s~\n",	ch->s8_16);
     if (!IS_NULLSTR(ch->s8_17))
	fprintf( fp, "Song8_17 %s~\n",	ch->s8_17);
     if (!IS_NULLSTR(ch->s8_18))
	fprintf( fp, "Song8_18 %s~\n",	ch->s8_18);
     if (!IS_NULLSTR(ch->s8_19))
	fprintf( fp, "Song8_19 %s~\n",	ch->s8_19);
     if (!IS_NULLSTR(ch->s8_20))
	fprintf( fp, "Song8_20 %s~\n",	ch->s8_20);
     if (!IS_NULLSTR(ch->s8_21))
	fprintf( fp, "Song8_21 %s~\n",	ch->s8_21);

     if (!IS_NULLSTR(ch->s9_0))
	fprintf( fp, "Song9_0 %s~\n",	ch->s9_0);
     if (!IS_NULLSTR(ch->s9_1))
	fprintf( fp, "Song9_1 %s~\n",	ch->s9_1);
     if (!IS_NULLSTR(ch->s9_2))
	fprintf( fp, "Song9_2 %s~\n",	ch->s9_2);
     if (!IS_NULLSTR(ch->s9_3))
	fprintf( fp, "Song9_3 %s~\n",	ch->s9_3);
     if (!IS_NULLSTR(ch->s9_4))
	fprintf( fp, "Song9_4 %s~\n",	ch->s9_4);
     if (!IS_NULLSTR(ch->s9_5))
	fprintf( fp, "Song9_5 %s~\n",	ch->s9_5);
     if (!IS_NULLSTR(ch->s9_6))
	fprintf( fp, "Song9_6 %s~\n",	ch->s9_6);
     if (!IS_NULLSTR(ch->s9_7))
	fprintf( fp, "Song9_7 %s~\n",	ch->s9_7);
     if (!IS_NULLSTR(ch->s9_8))
	fprintf( fp, "Song9_8 %s~\n",	ch->s9_8);
     if (!IS_NULLSTR(ch->s9_9))
	fprintf( fp, "Song9_9 %s~\n",	ch->s9_9);
     if (!IS_NULLSTR(ch->s9_10))
	fprintf( fp, "Song9_10 %s~\n",	ch->s9_10);
     if (!IS_NULLSTR(ch->s9_11))
	fprintf( fp, "Song9_11 %s~\n",	ch->s9_11);
     if (!IS_NULLSTR(ch->s9_12))
	fprintf( fp, "Song9_12 %s~\n",	ch->s9_12);
     if (!IS_NULLSTR(ch->s9_13))
	fprintf( fp, "Song9_13 %s~\n",	ch->s9_13);
     if (!IS_NULLSTR(ch->s9_14))
	fprintf( fp, "Song9_14 %s~\n",	ch->s9_14);
     if (!IS_NULLSTR(ch->s9_15))
	fprintf( fp, "Song9_15 %s~\n",	ch->s9_15);
     if (!IS_NULLSTR(ch->s9_16))
	fprintf( fp, "Song9_16 %s~\n",	ch->s9_16);
     if (!IS_NULLSTR(ch->s9_17))
	fprintf( fp, "Song9_17 %s~\n",	ch->s9_17);
     if (!IS_NULLSTR(ch->s9_18))
	fprintf( fp, "Song9_18 %s~\n",	ch->s9_18);
     if (!IS_NULLSTR(ch->s9_19))
	fprintf( fp, "Song9_19 %s~\n",	ch->s9_19);

     if (!IS_NULLSTR(ch->s10_0))
	fprintf( fp, "Song10_0 %s~\n",	ch->s10_0);
     if (!IS_NULLSTR(ch->s10_1))
	fprintf( fp, "Song10_1 %s~\n",	ch->s10_1);
     if (!IS_NULLSTR(ch->s10_2))
	fprintf( fp, "Song10_2 %s~\n",	ch->s10_2);
     if (!IS_NULLSTR(ch->s10_3))
	fprintf( fp, "Song10_3 %s~\n",	ch->s10_3);

     if (!IS_NULLSTR(ch->s11_0))
	fprintf( fp, "Song11_0 %s~\n",	ch->s11_0);
     if (!IS_NULLSTR(ch->s11_1))
	fprintf( fp, "Song11_1 %s~\n",	ch->s11_1);
     if (!IS_NULLSTR(ch->s11_2))
	fprintf( fp, "Song11_2 %s~\n",	ch->s11_2);
     if (!IS_NULLSTR(ch->s11_3))
	fprintf( fp, "Song11_3 %s~\n",	ch->s11_3);
     if (!IS_NULLSTR(ch->s11_4))
	fprintf( fp, "Song11_4 %s~\n",	ch->s11_4);
     if (!IS_NULLSTR(ch->s11_5))
	fprintf( fp, "Song11_5 %s~\n",	ch->s11_5);
     if (!IS_NULLSTR(ch->s11_6))
	fprintf( fp, "Song11_6 %s~\n",	ch->s11_6);
     if (!IS_NULLSTR(ch->s11_7))
	fprintf( fp, "Song11_7 %s~\n",	ch->s11_7);
     if (!IS_NULLSTR(ch->s11_8))
	fprintf( fp, "Song11_8 %s~\n",	ch->s11_8);
     if (!IS_NULLSTR(ch->s11_9))
	fprintf( fp, "Song11_9 %s~\n",	ch->s11_9);
     if (!IS_NULLSTR(ch->s11_10))
	fprintf( fp, "Song11_10 %s~\n",	ch->s11_10);
     if (!IS_NULLSTR(ch->s11_11))
	fprintf( fp, "Song11_11 %s~\n",	ch->s11_11);

     if (!IS_NULLSTR(ch->s12_0))
	fprintf( fp, "Song12_0 %s~\n",	ch->s12_0);
     if (!IS_NULLSTR(ch->s12_1))
	fprintf( fp, "Song12_1 %s~\n",	ch->s12_1);
     if (!IS_NULLSTR(ch->s12_2))
	fprintf( fp, "Song12_2 %s~\n",	ch->s12_2);
     if (!IS_NULLSTR(ch->s12_3))
	fprintf( fp, "Song12_3 %s~\n",	ch->s12_3);

	 if(ch->altformed){
 
 		fprintf( fp, "OShD  %s~\n", fix_string(ch->orig_short_descr));
 		fprintf( fp, "ODesc  %s~\n", fix_string(ch->orig_description));
	 }else{
 	...
 	if (ch->poly_description)
 		fprintf( fp, "PDesc  %s~\n", fix_string(ch->poly_description));
 
//     	if (ch->orig_race != 0)
// 		fprintf( fp, "ORace  %s~\n", race_table[ch->orig_race]->name );
//     	else fprintf( fp, "ORace  %s~\n", race_table[ch->race]->name );

 	// Addition for Deity Essence
 	if (!IS_NPC(ch) && ch->pcdata->essence)
 	{
 		fprintf ( fp, "Essence   %d\n",	ch->pcdata->essence );
 	}
 
	if(!IS_NPC(ch) && ch->altform.type != 0)
	{
		fprintf(fp, "AltType %d\n", ch->altform.type);
		fprintf(fp, "AltSubtype %d\n", ch->altform.subtype);
		fprintf(fp, "AltShD %s~\n", ch->altform.short_descr);
		fprintf(fp, "AltDesc %s~\n", fix_string(ch->altform.description));
		fprintf(fp, "Altformed %s~\n", ch->altformed ? "yes" : "no");
		fprintf(fp, "Alttimer %d\n",	ch->altform.timer);
	}
 	// Addition for Deity Rank
 	if (!IS_NPC(ch) && ch->pcdata->deityrank)
 	{
 		fprintf ( fp, "DeityRank   %d\n",	ch->pcdata->deityrank );
 	}
	...
	if ( !IS_NPC( ch ))
	{
		...
		if (ch->title){
			fwrite_wordflag( title_flags, ch->title, "Pretitle", fp);
		}
	}
    // stats
	...
	if (ch->affected_by3){
		fwrite_wordflag( affect3_flags, ch->affected_by2, "AfBy3", fp);
	}

	if ( !IS_NULLSTR( ch->fealty )){
			fprintf( fp, "Fealty   %s~\n",  fix_string(ch->fealty) );
	}

	if (ch->vampire){
		fwrite_wordflag( vampire_flags, ch->vampire, "Vampire", fp);
	}

	if (!IS_NULLSTR(ch->pet1)){
			fprintf( fp, "Kennel1   %s~\n",  fix_string(ch->pet1) );
	}

	if (!IS_NULLSTR(ch->pet2)){
			fprintf( fp, "Kennel2   %s~\n",  fix_string(ch->pet2) );
	}

	if (!IS_NULLSTR(ch->pet3)){
			fprintf( fp, "Kennel3   %s~\n",  fix_string(ch->pet3) );
	}

	if (!IS_NULLSTR(ch->pet4)){
			fprintf( fp, "Kennel4   %s~\n",  fix_string(ch->pet4) );
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[0])){
			fprintf( fp, "Ignore0   %s~\n", fix_string(ch->pcdata->ignore[0]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[1])){
			fprintf( fp, "Ignore1   %s~\n", fix_string(ch->pcdata->ignore[1]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[2])){
			fprintf( fp, "Ignore2   %s~\n", fix_string(ch->pcdata->ignore[2]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[3])){
			fprintf( fp, "Ignore3   %s~\n", fix_string(ch->pcdata->ignore[3]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[4])){
			fprintf( fp, "Ignore4   %s~\n", fix_string(ch->pcdata->ignore[4]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[5])){
			fprintf( fp, "Ignore5   %s~\n", fix_string(ch->pcdata->ignore[5]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[6])){
			fprintf( fp, "Ignore6   %s~\n", fix_string(ch->pcdata->ignore[6]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[7])){
			fprintf( fp, "Ignore7   %s~\n", fix_string(ch->pcdata->ignore[7]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[8])){
			fprintf( fp, "Ignore8   %s~\n", fix_string(ch->pcdata->ignore[8]));
	}
	if (!IS_NULLSTR(ch->pcdata->ignore[9])){
			fprintf( fp, "Ignore9   %s~\n", fix_string(ch->pcdata->ignore[9]));
	}
	...
	if (ch->wish){
		fwrite_wordflag( wish_flags, ch->wish, "Wish", fp);
	}

	if (ch->style){
		fwrite_wordflag( style_flags, ch->style, "style", fp);
	}

	if (ch->territory1){
		fwrite_wordflag( territory1_flags, ch->territory1, "Terr1", fp);
	}
...
void fwrite_obj( obj_data *obj, FILE *fp, int iNest, char *heading )
{
	...
	fprintf( fp, "OVal  %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld\n",
		obj->ospec_value[0], obj->ospec_value[1], obj->ospec_value[2], obj->ospec_value[3],
		obj->ospec_value[4], obj->ospec_value[5], obj->ospec_value[6], obj->ospec_value[7],
		obj->ospec_value[8], obj->ospec_value[9] );
...
void fread_char( char_data *ch, FILE *fp )
{
	...
	for ( ; ; )
	{
		...
		case 'A':		
			KEY( "AKill",	ch->pcdata->akills,  fread_number( fp ) );
			KEY( "ADeath",	ch->pcdata->adeaths,  fread_number( fp ) );	
			...
			KEY( "AltType",		ch->altform.type,			fread_number( fp ) ); 
			KEY( "AltTimer",		ch->altform.timer,		fread_number( fp ) ); 
			KEY( "AltSubtype",	ch->altform.subtype,		fread_number( fp ) ); 
			KEY( "AltShD",		ch->altform.short_descr,	fread_string( fp ) ); 
			KEY( "AltDesc",		ch->altform.description,	fread_string( fp ) ); 
			if ( !str_cmp( word, "Altformed")){
				char *altformed;
				altformed = fread_string(fp);
				if(!str_cmp(altformed, "yes"))
					ch->altformed = true;
				else
					ch->altformed = false;
				fMatch = true;
		...
		case 'B':
			...
			KEY( "Bloodpool",	ch->bloodpool, fread_number(fp));
		...
		case 'C':
			...
			KEY( "Crime", 		ch->pcdata->crime, 	fread_number(fp));
//			KEY( "Custom_colours", ch->pcdata->custom_colour,	fread_custom_colours(fp, true));
		...
		case 'D':
			...
			KEY( "DeityRank",	ch->pcdata->deityrank,	fread_number( fp ));
		...
		case 'E':
			...
			KEY( "Essence",		ch->pcdata->essence,	fread_number( fp ));
		...
		case 'I':
			KEY( "Ignore0",        ch->pcdata->ignore[0],  fread_string( fp ) );
			KEY( "Ignore1",        ch->pcdata->ignore[1],  fread_string( fp ) );
			KEY( "Ignore2",        ch->pcdata->ignore[2],  fread_string( fp ) );
			KEY( "Ignore3",        ch->pcdata->ignore[3],  fread_string( fp ) );
			KEY( "Ignore4",        ch->pcdata->ignore[4],  fread_string( fp ) );
			KEY( "Ignore5",        ch->pcdata->ignore[5],  fread_string( fp ) );
			KEY( "Ignore6",        ch->pcdata->ignore[6],  fread_string( fp ) );
			KEY( "Ignore7",        ch->pcdata->ignore[7],  fread_string( fp ) );
			KEY( "Ignore8",        ch->pcdata->ignore[8],  fread_string( fp ) );
			KEY( "Ignore9",        ch->pcdata->ignore[9],  fread_string( fp ) );
 		...
 		case 'J':
 			KEY( "Jail", ch->pcdata->jail, (time_t)fread_number( fp ));
 			break;
			
		case 'K':
			KEY( "Karns", ch->pcdata->karns, fread_number(fp));
			KEY( "KCntd", ch->pcdata->next_karn_countdown, fread_number(fp));
			KEY( "Kennel1", ch->pet1, fread_string( fp ) );
			KEY( "Kennel2", ch->pet2, fread_string( fp ) );
			KEY( "Kennel3", ch->pet3, fread_string( fp ) );
			KEY( "Kennel4", ch->pet4, fread_string( fp ) );
				...
				if (IS_OLD_CHVER(ch)){
					...
					if(!ch->language){ 
						bugf("fread_char: Unfound language '%s' in %s's pfile!",
							read_buf, ch->name);
						ch->language = language_lookup("common");
					}
					free_string(read_buf);				
				}
				if(!ch->language){
					logf("Language set to default for '%s'", ch->name);
...
//			KEY( "NoteNet",ch->notenet,	fread_wordflag( notenet_flags, fp ));
		...
		case 'O':
			...
			KEY( "OlcWizi",		ch->olcwizi,	fread_number( fp ) );
 			KEY( "OShD",	ch->orig_short_descr,	fread_string( fp ));
 			KEY( "ODescription",	ch->orig_description,        fread_string( fp ));
 			KEY( "ODesc",		ch->orig_description,        fread_string( fp ));
 			if ( !str_cmp( word, "ORace" ) )
			{
 				ch->orig_race = race_lookup(fread_string( fp ));
 				if (ch->orig_race == -1)
 				{
 					ch->orig_race = race_lookup("human");
 					bugf("fread_char: ch '%s' has an invalid original race!!!",
 						ch->name);
				}else
		...
		case 'P':
			...
			KEY( "Points", ch->pcdata->points,     fread_number( fp ) );
 			KEY( "Posing",	ch->posing,		fread_string( fp ));
 			KEY( "PShD",	ch->poly_short,		fread_string( fp ));
			KEY( "PDesc",	ch->poly_description,   fread_string( fp ));
			KEY( "Pnts",        ch->pcdata->points,     fread_number( fp ) );
			KEY( "Practice",       ch->practice,           fread_number( fp ) );
			KEY( "Prac",        ch->practice,           fread_number( fp ) );
			KEY( "Pretitle",	    ch->title,    	fread_wordflag( title_flags, fp ));
			...
			KEY( "PrefColourInSocials",	ch->pcdata->preference_colour_in_socials,(PREFERENCE_TYPE)fread_wordflag( preference_types, fp ));
 			KEY( "Pregnant", ch->pcdata->pregnant, (time_t)fread_number( fp ));
        	...
        	case 'Q':
			KEY( "Quazer", ch->quazer, fread_number(fp));
		...
		case 'S':
			...
			KEY( "Song1_0",		ch->s1_0,		fread_string( fp ));
			KEY( "Song1_1",		ch->s1_1,		fread_string( fp ));
			KEY( "Song1_2",		ch->s1_2,		fread_string( fp ));
			KEY( "Song1_3",		ch->s1_3,		fread_string( fp ));
			KEY( "Song1_4",		ch->s1_4,		fread_string( fp ));
			KEY( "Song1_5",		ch->s1_5,		fread_string( fp ));
			KEY( "Song1_6",		ch->s1_6,		fread_string( fp ));
			KEY( "Song1_7",		ch->s1_7,		fread_string( fp ));

			KEY( "Song2_0",		ch->s2_0,		fread_string( fp ));
			KEY( "Song2_1",		ch->s3_1,		fread_string( fp ));
			KEY( "Song2_2",		ch->s2_2,		fread_string( fp ));
			KEY( "Song2_3",		ch->s2_3,		fread_string( fp ));
			KEY( "Song2_4",		ch->s2_4,		fread_string( fp ));
			KEY( "Song2_5",		ch->s2_5,		fread_string( fp ));
			KEY( "Song2_6",		ch->s2_6,		fread_string( fp ));
			KEY( "Song2_7",		ch->s2_7,		fread_string( fp ));

			KEY( "Song3_0",		ch->s3_0,		fread_string( fp ));
			KEY( "Song3_1",		ch->s3_1,		fread_string( fp ));
			KEY( "Song3_2",		ch->s3_2,		fread_string( fp ));
			KEY( "Song3_3",		ch->s3_3,		fread_string( fp ));
			KEY( "Song3_4",		ch->s3_4,		fread_string( fp ));
			KEY( "Song3_5",		ch->s3_5,		fread_string( fp ));
			KEY( "Song3_6",		ch->s3_6,		fread_string( fp ));
			KEY( "Song3_7",		ch->s3_7,		fread_string( fp ));
			KEY( "Song3_8",		ch->s3_8,		fread_string( fp ));
			KEY( "Song3_9",		ch->s3_9,		fread_string( fp ));
			KEY( "Song3_10",	ch->s3_10,		fread_string( fp ));
			KEY( "Song3_11",	ch->s3_11,		fread_string( fp ));

			KEY( "Song4_0",		ch->s4_0,		fread_string( fp ));
			KEY( "Song4_1",		ch->s4_1,		fread_string( fp ));
			KEY( "Song4_2",		ch->s4_2,		fread_string( fp ));
			KEY( "Song4_3",		ch->s4_3,		fread_string( fp ));

			KEY( "Song5_0",		ch->s5_0,		fread_string( fp ));
			KEY( "Song5_1",		ch->s5_1,		fread_string( fp ));
			KEY( "Song5_2",		ch->s5_2,		fread_string( fp ));
			KEY( "Song5_3",		ch->s5_3,		fread_string( fp ));
			KEY( "Song5_4",		ch->s5_4,		fread_string( fp ));

			KEY( "Song6_0",		ch->s6_0,		fread_string( fp ));
			KEY( "Song6_1",		ch->s6_1,		fread_string( fp ));
			KEY( "Song6_2",		ch->s6_2,		fread_string( fp ));
			KEY( "Song6_3",		ch->s6_3,		fread_string( fp ));
			KEY( "Song6_4",		ch->s6_4,		fread_string( fp ));
			KEY( "Song6_5",		ch->s6_5,		fread_string( fp ));

			KEY( "Song7_0",		ch->s7_0,		fread_string( fp ));
			KEY( "Song7_1",		ch->s7_1,		fread_string( fp ));
			KEY( "Song7_2",		ch->s7_2,		fread_string( fp ));
			KEY( "Song7_3",		ch->s7_3,		fread_string( fp ));
			KEY( "Song7_4",		ch->s7_4,		fread_string( fp ));
			KEY( "Song7_5",		ch->s7_5,		fread_string( fp ));

			KEY( "Song8_0",		ch->s8_0,		fread_string( fp ));
			KEY( "Song8_1",		ch->s8_1,		fread_string( fp ));
			KEY( "Song8_2",		ch->s8_2,		fread_string( fp ));
			KEY( "Song8_3",		ch->s8_3,		fread_string( fp ));
			KEY( "Song8_4",		ch->s8_4,		fread_string( fp ));
			KEY( "Song8_5",		ch->s8_5,		fread_string( fp ));
			KEY( "Song8_6",		ch->s8_6,		fread_string( fp ));
			KEY( "Song8_7",		ch->s8_7,		fread_string( fp ));
			KEY( "Song8_8",		ch->s8_8,		fread_string( fp ));
			KEY( "Song8_9",		ch->s8_9,		fread_string( fp ));
			KEY( "Song8_10",	ch->s8_10,		fread_string( fp ));
			KEY( "Song8_11",	ch->s8_11,		fread_string( fp ));
			KEY( "Song8_12",	ch->s8_12,		fread_string( fp ));
			KEY( "Song8_13",	ch->s8_13,		fread_string( fp ));
 			KEY( "Song8_14",	ch->s8_14,		fread_string( fp ));
			KEY( "Song8_15",	ch->s8_15,		fread_string( fp ));
			KEY( "Song8_16",	ch->s8_16,		fread_string( fp ));
			KEY( "Song8_17",	ch->s8_17,		fread_string( fp ));
			KEY( "Song8_18",	ch->s8_18,		fread_string( fp ));
			KEY( "Song8_19",	ch->s8_19,		fread_string( fp ));
			KEY( "Song8_20",	ch->s8_20,		fread_string( fp ));
			KEY( "Song8_21",	ch->s8_21,		fread_string( fp ));

			KEY( "Song9_0",	ch->s9_0,		fread_string( fp ));
			KEY( "Song9_1",	ch->s9_1,		fread_string( fp ));
			KEY( "Song9_2",	ch->s9_2,		fread_string( fp ));
			KEY( "Song9_3",	ch->s9_3,		fread_string( fp ));
			KEY( "Song9_4",	ch->s9_4,		fread_string( fp ));
			KEY( "Song9_5",	ch->s9_5,		fread_string( fp ));
			KEY( "Song9_6",	ch->s9_6,		fread_string( fp ));
			KEY( "Song9_7",	ch->s9_7,		fread_string( fp ));
			KEY( "Song9_8",	ch->s9_8,		fread_string( fp ));
			KEY( "Song9_9",	ch->s9_9,		fread_string( fp ));
			KEY( "Song9_10",	ch->s9_10,		fread_string( fp ));
			KEY( "Song9_11",	ch->s9_11,		fread_string( fp ));
			KEY( "Song9_12",	ch->s9_12,		fread_string( fp ));
			KEY( "Song9_13",	ch->s9_13,		fread_string( fp ));
			KEY( "Song9_14",	ch->s9_14,		fread_string( fp ));
			KEY( "Song9_15",	ch->s9_15,		fread_string( fp ));
			KEY( "Song9_16",	ch->s9_16,		fread_string( fp ));
			KEY( "Song9_17",	ch->s9_17,		fread_string( fp ));
			KEY( "Song9_18",	ch->s9_18,		fread_string( fp ));
			KEY( "Song9_19",	ch->s9_19,		fread_string( fp ));

			KEY( "Song10_0",	ch->s10_0,		fread_string( fp ));
			KEY( "Song10_1",	ch->s10_1,		fread_string( fp ));
			KEY( "Song10_2",	ch->s10_2,		fread_string( fp ));
			KEY( "Song10_3",	ch->s10_3,		fread_string( fp ));

			KEY( "Song11_0",	ch->s11_0,		fread_string( fp ));
			KEY( "Song11_1",	ch->s11_1,		fread_string( fp ));
			KEY( "Song11_2",	ch->s11_2,		fread_string( fp ));
			KEY( "Song11_3",	ch->s11_3,		fread_string( fp ));
			KEY( "Song11_4",	ch->s11_4,		fread_string( fp ));
			KEY( "Song11_5",	ch->s11_5,		fread_string( fp ));
			KEY( "Song11_6",	ch->s11_6,		fread_string( fp ));
			KEY( "Song11_7",	ch->s11_7,		fread_string( fp ));
			KEY( "Song11_8",	ch->s11_8,		fread_string( fp ));
			KEY( "Song11_9",	ch->s11_9,		fread_string( fp ));
			KEY( "Song11_10",	ch->s11_10,		fread_string( fp ));
			KEY( "Song11_11",	ch->s11_11,		fread_string( fp ));

			KEY( "Song12_0",	ch->s12_0,		fread_string( fp ));
			KEY( "Song12_1",	ch->s12_1,		fread_string( fp ));
			KEY( "Song12_2",	ch->s12_2,		fread_string( fp ));
			KEY( "Song12_3",	ch->s12_3,		fread_string( fp ));


			KEY( "Songp",		ch->songp,            fread_number( fp ));
			KEY( "Songn",		ch->songn,            fread_number( fp ));


			KEY( "Stun",		ch->is_stunned,				fread_number( fp ));
			KEY( "Style",	    	ch->style,    		fread_wordflag( style_flags, fp ));
			...
			if ( !str_cmp( word, "Skill" ) || !str_cmp(word,"Sk"))
			{
				...
				if ( !str_cmp( temp, "human" ))
					ch->pcdata->learned[gsn_common]=100; 
				if ( !str_cmp( temp, "drow" ))
					ch->pcdata->learned[gsn_undercommon]=100;
				if ( !str_cmp( temp, "faerie" ))
					ch->pcdata->learned[gsn_sylvan]=100;
				if ( !str_cmp( temp, "illithid" ))
					ch->pcdata->learned[gsn_undercommon]=100;
		...
		case 'T':
			...
			KEY( "Terr1",	    ch->territory1,    fread_wordflag( territory1_flags, fp ));
			KEY( "Tired",		ch->pcdata->tired,			fread_number( fp ));
			KEY( "TrueSex",     ch->pcdata->true_sex,		fread_number( fp ));
			KEY( "Trai",		ch->train,					fread_number( fp ));
			KEY( "Title",		ch->pcdata->title,			fread_string( fp ));
			KEY( "Theft", 		ch->pcdata->theft,		fread_number( fp ));
		...
		case 'V':
			...
			KEY( "Vampire",	    ch->vampire,    fread_wordflag( vampire_flags, fp ));
		...
		case 'W':
			...
			KEY( "Werecircle",		ch->werecircle,		fread_number( fp ));
			KEY( "Wimpy",		ch->wimpy,				fread_number( fp ));
			KEY( "Wimp",		ch->wimpy,				fread_number( fp ));
			KEY( "Wdie",		ch->will_die,			fread_number( fp ));
			KEY( "Wish",	    	ch->wish,    		fread_wordflag( wish_flags, fp ));
...
obj_data * fread_obj( FILE *fp, const char *filename )
{
    ...
    for ( ; ; )
    {
		...
		case 'O':
			...
			{
				obj->ospec_value[0]   = fread_number( fp );
				obj->ospec_value[1]   = fread_number( fp );
				obj->ospec_value[2]   = fread_number( fp );
				obj->ospec_value[3]   = fread_number( fp );
				obj->ospec_value[4]   = fread_number( fp );
				obj->ospec_value[5]   = fread_number( fp );
				obj->ospec_value[6]   = fread_number( fp );
				obj->ospec_value[7]   = fread_number( fp );
				obj->ospec_value[8]   = fread_number( fp );
				obj->ospec_value[9]   = fread_number( fp );
				fMatch = true;
				break;
			}

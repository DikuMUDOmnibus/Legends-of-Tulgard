...
bool medit_show(char_data *ch, char *)
{
	...
	mxp_display_olc_flags(ch, part_flags,	pMob->parts,"part", "Parts:");
   	...
   	mxp_display_olc_flags(ch, terr_restrict_flags,	pMob->terr_restrict,	"terr", "Terr Restricts:");
...
bool medit_create(char_data *ch, char *argument)
{
	...
	if ( ( race = race_lookup( "human") ) != -1 )
    {
		...
		pMob->terr_restrict  |= race_table[race]->terr_restrict;	
    }
...
/**************************************************************************/
bool medit_terrain_restrict(char_data *ch, char *argument)
{
    MOB_INDEX_DATA *pMob;
	EDIT_MOB( ch, pMob );
	return olc_generic_flag_toggle(ch, argument, 
		"terr", "terr", terr_restrict_flags, &pMob->terr_restrict);
}
/**************************************************************************/
...
bool medit_copy(char_data *ch, char *argument)
{
	...
	pMob->terr_restrict		= pSrc->terr_restrict;	

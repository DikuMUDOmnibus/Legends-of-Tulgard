...
public:
	...
	// Ixliam
	locker_data *find_prison_data(char *owner, int roomvnum);
	locker_data *find_prison(char_data *ch, bool display_messages);
	void prison_start(char_data *ch );
	void prison_end(char_data *ch ); 

...
/**************************************************************************/
// act_move.cpp
void    move_char( char_data *ch, int door, bool follow, char *argument );
...
char    *projectile_name( int projectile_flags  );
...
char	*vampire_bit_name( int vector );
char	*werebeast_bit_name( int vector );
char	*title_bit_name( int vector );
char	*crime_bit_name( int vector );
char	*wish_bit_name( int vector );
char	*style_bit_name( int vector );
...
bool	mp_event_trigger( char_data *mob, char_data *ch,            
							const void *arg1, const void *arg2, int type );
...
//***************************************************
	...
	void highlander_broadcast(char_data *ch, char * fmt, ...);
	void judge_broadcast(char_data *ch, char * fmt, ...);
#else
	...
	void highlander_broadcast(char_data *ch, char * fmt, ...) __attribute__ ((format(printf,2,3)));
	void judge_broadcast(char_data *ch, char * fmt, ...) __attribute__ ((format(printf,2,3)));
#endif

...
#include "immquest.h"
#include "trap.h"
#include "afteraff.h" //afteraffects
...
{	
	...
	{  "nohunt",			ACT2_NOHUNT,			true   },		
	{  "avoids_all_attacks",ACT2_AVOIDS_ALL_ATTACKS,true	},	
	{  "no_tendency",		ACT2_NO_TENDENCY,		true	},		
 	{  "dealer",			ACT2_DEALER,			true    },
 	{  "arena_challenged",		ACT2_PLR_CHALLENGED,		false   },
 	{  "arena_challenger",		ACT2_PLR_CHALLENGER,		false   },
 	{  "war_team_red",		ACT2_WAR_RED,			false	},
 	{  "war_team_blue",		ACT2_WAR_BLUE,			false	},
 	{  "crime_points",		ACT2_CRIME,			true	},
 	{  "murder_5_pts",		ACT2_MURDER_5,			true	},
 	{  "murder_10_pts",		ACT2_MURDER_10,			true	},
 	{  "murder_25_pts",		ACT2_MURDER_25,			true	},
 	{  "murder_50_pts",		ACT2_MURDER_50,			true	},
 	{  "murder_100_pts",		ACT2_MURDER_100,		true	},
 	{  "under_arrest",		ACT2_UNDERARREST,		false	},	
 	{  "license_dealer",		ACT2_LICENSE_DEALER,		true	},
 	{  "deck_of_fate",		ACT2_DECK_OF_FATE,		true	},
 	{  "allow_embrace",		ACT2_ALLOWEMBRACE,		false	},
 	{  "allow_feed",		ACT2_ALLOWFEED,			true	},		
 	{  "repair_man",		ACT2_REPAIRMAN,			true	},
 	{  "forger",			ACT2_FORGER,			true	},	
 	{  "court_judge",		ACT2_COURTJUDGE,		true	},	
	{  "no_random_obj",		ACT2_NO_RANDOM_OBJ,		true	},	
	{  "letter_courier",		ACT2_LETTER_COURIER,		true	},
	{  "pet_kennel",		ACT2_KENNEL,			true	},
	{  "egg_pet",			ACT2_EGGPET,			false	},
	{  "clan_maker",		ACT2_CLANMAKER,			true	},
	{  NULL,				0,						0   }
};
...
const struct flag_type form_flags[] =
{
    ...
    {   "non_skinable",         FORM_NON_SKINABLE,      true    }, 
    ...
    {	"terrain_restricted",	FORM_TERR_RESTRICT,	true	},
    {	NULL,					0,						0		}
};
...
const struct flag_type room2_flags[]=
{
    ...
    {  "saltwater_fish",	ROOM2_SALTWATER_FISH,	true    },
    {  "freshwater_fish",	ROOM2_FRESHWATER_FISH,	true    },
    {  "arena",			ROOM2_ARENA,		true    },
    {  "war_room",		ROOM2_WAR,		true    },
    {  "no_shadowplane",	ROOM2_NO_SHADOWPLANE,	true    },
    {  "territory_1",		ROOM2_TERR_1,		true    },
    {  "territory_2",		ROOM2_TERR_2,		true    },
    {  "territory_3",		ROOM2_TERR_3,		true    },
    {  "territory_4",		ROOM2_TERR_4,		true    },
    {  "territory_5",		ROOM2_TERR_5,		true    },
    {  "territory_6",		ROOM2_TERR_6,		true    },
    {  "territory_7",		ROOM2_TERR_7,		true    },
    {  "territory_8",		ROOM2_TERR_8,		true    },
    {  "territory_9",		ROOM2_TERR_9,		true    },
    {  "territory_10",		ROOM2_TERR_10,		true    },
    {  "storage_room",		ROOM2_STORAGE,		true    },
    {  "no_clan",		ROOM2_NOCLAN,		true    },
    {  "player_shop",		ROOM2_PLAYER_SHOP,	true    },
    {  "player_shop_storage",	ROOM2_PC_SHOP_STORAGE,	true    },
    {  "no_steal",		ROOM2_NOSTEAL,		true    },
    {  NULL,                0,                      0		}
};
...
const struct flag_type sector_types[] =
{
	...
	{	"lava",		SECT_LAVA, 			true	},
 	{   	"gateway",	SECT_GATEWAY,		true	},
 	{   	"vehicle",	SECT_VEHICLE,		true	},
	{	NULL,		0,					0	}
};


const struct flag_type terr_restrict_flags[] =
{
	{	"inside",	TERR_INSIDE,			true	},
	{	"city", 	TERR_CITY,			true	},
	{	"field",	TERR_FIELD, 			true	},
	{	"forest",	TERR_FOREST,			true	},
	{	"hills",	TERR_HILLS, 			true	},
	{	"mountain", 	TERR_MOUNTAIN,			true	},
	{	"swim", 	TERR_WATER_SWIM,		true	},
	{	"noswim",	TERR_WATER_NOSWIM,		true	},
    	{   	"swamp",    	TERR_SWAMP,         		true    },
	{	"air",		TERR_AIR,			true	},
	{	"desert",	TERR_DESERT,			true	},
	{	"cave",		TERR_CAVE,			true	},
	{	"underwater",	TERR_UNDERWATER,		true	},
	{	"snow",		TERR_SNOW,			true	},
	{   	"ice",		TERR_ICE,			true	},
	{   	"trail",	TERR_TRAIL,			true	},
	{	"lava",		TERR_LAVA, 			true	},
	{	NULL,		0,				0	}
};
...
const struct flag_type item_types[] =
{
    ...
    {  "fishingpole",	ITEM_POLE,	    true    }, // Ixliam
    {  "firearm",       ITEM_FIREARM,       true    }, // Ixliam
    ...
    {  "projectile",    ITEM_PROJECTILE,    true    }, // Ixliam
    {  "protect",       ITEM_PROTECT,       true    },
    {  "quiver",    	ITEM_QUIVER,        true    }, // Ixliam
    {  "roomkey",       ITEM_ROOM_KEY,      true    },
    {  "rune",       	ITEM_RUNE,          true    }, // Ixliam
    {  "rp",            ITEM_RP,            true    },
    {  "scroll",        ITEM_SCROLL,        true    },
    {  "slotmachine",	ITEM_SLOTMACHINE,   true    }, // Ixliam
    {  "staff",         ITEM_STAFF,         true    },
    {  "stargate",      ITEM_STARGATE,      true    }, // Ixliam
    {  "tabac_pipe",	ITEM_TABAC_PIPE,    true    }, // Ixliam
    {  "token",         ITEM_TOKEN,         true    },
    {  "trash",         ITEM_TRASH,         true    },
    {  "treasure",      ITEM_TREASURE,      true    },
    {  "vehicle",           ITEM_VEHICLE,      		true    }, // Ixliam
    {  "vehicle_controls",  ITEM_VEHICLE_CONTROLS,  	true    }, // Ixliam
    {  "vehicle_exit",      ITEM_VEHICLE_EXIT,  	true    }, // Ixliam
    {  "vehicle_window",    ITEM_VEHICLE_WINDOW,   	true    }, // Ixliam
    {  "wand",          ITEM_WAND,          true    },
...
const struct flag_type objextra2_flags[]=
{
	...
	{  "shadowplane",	OBJEXTRA2_SHADOWPLANE,		true	}, // Ixliam
	{  "clan_item",		OBJEXTRA2_CLANITEM,		true 	}, // Ixliam
	{  "runic_item",	OBJEXTRA2_RUNIC,		true 	}, // Ixliam
	{  "noidentify",	OBJEXTRA2_NOIDENTIFY,	true	}, // Reath
	{  "regrowing",		OBJEXTRA2_REGROWING,	true	}, // Reath
// not to be set in olc, will have it's own command since it will be a bit more specialized
	{  "trap",		OBJEXTRA2_TRAP,			false	}, // Ixliam
	{  "non_skinable",	OBJEXTRA2_NON_SKINABLE,		false 	}, // Ixliam
	{  "player_crafted",	OBJEXTRA2_PC_CRAFTED,		false 	}, // Ixliam
// below from vot - false till actually do something
	...
	{  "vampire_bane",	OBJEXTRA2_VAMPIRE_BANE,		false 	}, 
		{ "tinkered",   OBJEXTRA2_TINKERED,			true	},
    	{  NULL,			0,          0   }
};
...
const struct flag_type apply_types[] =
{
	...
	{  "all_attributes",	APPLY_ATTRIBUTES,		true	},
    {  "sex",				APPLY_SEX,				true    },
...
const struct flag_type wear_location_strings_types[] =
{
    ...
    {  "wielded (third hand)",		WEAR_2WIELD,		true    },
    {  "held in the forth hand",	WEAR_2HOLD,		true    },
    {  "wielded (fourth hand)",  	WEAR_2SECONDARY,	true    },
    {  NULL,           0         , 0   }
};
...
const struct flag_type wear_location_types[] =
{
	...
	{  "rankle",		WEAR_ANKLE_R,		true	},
 	{  "back",			WEAR_BACK,			true	},
    {  "3rd_wield",		WEAR_2WIELD,		true    },
    {  "4th_hold",		WEAR_2HOLD,		true    },
    {  "4th_wield",   		WEAR_2SECONDARY,		true    },
    {  NULL,       0,      0   }	
};	
...
const struct flag_type container_flags[] =
{
    ...
    {  "treasury",		CONT_LOCKER,		false	}, // used to redirect lock without a key
    {  NULL,	0,      0   }
};
...
const struct flag_type projectile_class_types[] =
{
    {  "arrow",		PROJ_ARROW,	true    },
    {  "bolt",		PROJ_BOLT,	true    },
    {  "dart",		PROJ_DART,	true    },
    {  "stone",		PROJ_STONE,	true    },
    {   NULL,      0,          0       }
};
...
const struct flag_type affect2_flags[] = // some false to implemented?
{
	{ "possession",			AFF2_POSSESSION,		false	},// not yet implemented
 	{ "no_vampire",			AFF2_NO_VAMP,			false	},
 	{ "vamp_bite",			AFF2_VAMP_BITE,			false	},
 	{ "lycanthrope",		AFF2_LYCANTHROPE,		false	},
 	{ "stockade",			AFF2_STOCKADE,			false	},
	{ "fade",			AFF2_FADE,			false	},// not yet implemented
	{ "ban_from_deck",		AFF2_BAN_DECK,			false	},	
	{ "shadowsight",		AFF2_SHADOWSIGHT,		true	},
	{ "no_werewolf",		AFF2_NO_WEREWOLF,		false	},
	{ "no_dispel",			AFF2_NO_DISPEL ,		true	},
	{ "mute",			AFF2_MUTE,			true	}, // Ixliam
	...
	{ "etheral",			AFF2_ETHEREAL,			true	}, // Ixliam
	{ "shadowplane",		AFF2_SHADOWPLANE,		true	}, // Ixliam
	{ "polymorph",			AFF2_POLYMORPH,			false	},// Ixliam
	{ "hallucinate",		AFF2_HALLUCINATE,		false	},// Ixliam
	{ "vicegrip",			AFF2_VICEGRIP,			true	},
	{ "stockade",			AFF2_STOCKADE,			false	}, // Ixliam
	{ "stone_gargoyle",		AFF2_STONE_GARGOYLE,		false	}, // Ixliam
 	{ "bountyhunter",		AFF2_BOUNTYHUNTER,		false	}, // Ixliam
 	{ "despair",			AFF2_DESPAIR,			false	}, // Ixliam
 	{ "dragon",			AFF2_DRAGON,		true	}, // Ixliam
   	{ "shapeshift",			AFF2_SHAPESHIFT,		false	}, // Ixliam
	{ "highlander",			AFF2_HIGHLANDER,		false	}, // Ixliam
	{ "dead_highlander",		AFF2_NO_HIGHLANDER,		false	}, // Ixliam
	{ "pregnant",			AFF2_PREGNANT,			false	}, // Ixliam
	{  NULL,	 0,  0	 }
};

const struct flag_type affect3_flags[] = //some false to implemented.
{
	{  NULL,	 0,  0	 }
};

const struct flag_type title_flags[] = 
{
	{ "king",		TITLE_KING,			true	},
	{ "queen",		TITLE_QUEEN,			true	},
	{ "duke",		TITLE_DUKE,			true	},
	{ "duchess",		TITLE_DUCHESS,			true	},
	{ "baron",		TITLE_BARON,			true	},
	{ "baroness",		TITLE_BARONESS,			true	},
	{ "lord",		TITLE_LORD,			true	},
	{ "lady",		TITLE_LADY,			true	},
	{ "sir",		TITLE_SIR,			true	},
	{ "dame",		TITLE_DAME,			true	},
	{ "page",		TITLE_PAGE,			true	},
	{ "squire",		TITLE_SQUIRE,			true	},
	{ "marquis",		TITLE_MARQUIS,			true	},
	{ "marquesta",		TITLE_MARQUESTA,		true	},
	{ "count",		TITLE_COUNT,			true	},
	{ "countess",		TITLE_COUNTESS,			true	},
	{ "prince",		TITLE_PRINCE,			true	},
	{ "princess",		TITLE_PRINCESS,			true	},
	{ "captain",		TITLE_CAPTAIN,			true	},
	{ "man-At-Arms",	TITLE_MAN_AT_ARMS,		true	},
	{ "jester",		TITLE_JESTER,			true	},
	{ "priest",		TITLE_PRIEST,			true	},
	{ "priestess",		TITLE_PRIESTESS,		true	},
	{ "mayor",		TITLE_MAYOR,			true	},
	{ "archmage",		TITLE_ARCHMAGE,			true	},
	{ "acolyte",		TITLE_ACOLYTE,			true	},
	{ "ambassador",		TITLE_AMBASSADOR,		true	},
	{ "governor",		TITLE_GOVERNOR,			true	},
	{ "master",		TITLE_MASTER,			true	},
	{ "mistress",		TITLE_MISTRESS,			true	},
	{ "apprentice",		TITLE_APPRENTICE,		true	},
	{  NULL,		0,				0	}
};

const struct flag_type vampire_flags[] = 
{
	{ "fangs",		VAM_FANGS,		false	},
	{ "claws",		VAM_CLAWS,		false	},
	{ "nightsight",		VAM_NIGHTSIGHT,		false	},
	{ "protean",		VAM_PROTEAN,		false	},
	{ "celerity",		VAM_CELERITY,		false	},
	{ "fortitude",		VAM_FORTITUDE,		false	},
	{ "potence",		VAM_POTENCE,		false	},
	{ "obfuscate",		VAM_OBFUSCATE,		false	},
	{ "auspex",		VAM_AUSPEX,		false	},
	{ "obtenebration",	VAM_OBTENEBRATION,	false	},
	{ "serpentis",		VAM_SERPENTIS,		false	},
	{ "disguised",		VAM_DISGUISED,		false	},
	{ "vamp_prince",	VAM_PRINCE,		false	},
	{ "dominate",		VAM_DOMINATE,		false	},
	{ "brujah",		VAM_BRUJAH,		false	},
	{ "assamite",		VAM_ASSAMITE,		false	},
	{ "cappadocian",	VAM_CAPPADOCIAN,	false	},
	{ "gangrel",		VAM_GANGREL,		false	},
	{ "malkavian",		VAM_MALKAVIAN,		false	},
	{ "nosferatu",		VAM_NOSFERATU,		false	},
	{ "toreador",		VAM_TOREADOR,		false	},
	{ "tremere",		VAM_TREMERE,		false	},
	{ "ventrue",		VAM_VENTRUE,		false	},
	{ "can_sire",		VAM_CAN_SIRE,		false	},
	{ "bat_form",		VAM_BAT,		false	},
	{ "mist_form",		VAM_MIST,		false	},
	{ "wolf_form",		VAM_WOLF,		false	},
	{ "human_form",		VAM_HUMAN,		false	},
	{ "immune_stake",	VAM_IMM_STAKE,		false	},
	{ "truesight",		VAM_TRUESIGHT,		false	},
	{ "snake_form",		VAM_SNAKE,		false	},
	{  NULL,	0,			0	}
};
...
const struct flag_type config2_flags[] =
{
	...
	{  "autosaycolorcodes",	CONFIG2_AUTOSAYCOLOURCODES,	false },
	...
	{  "autokeepalive",			CONFIG2_AUTOKEEPALIVE,	false },
 	{  "sheathed",		CONFIG2_SHEATHED,	false },
 	{  "concealed",		CONFIG2_CONCEALED,	false },
 	{  "cloaked",		CONFIG2_CLOAKED,	false },
 	{  "fishing",		CONFIG2_FISHING,	false },
 	{  "fish_on",		CONFIG2_FISH_ON,	false },
 	{  "judge",		CONFIG2_JUDGE,		false },
 	{  "vote_yes",		CONFIG2_VOTEYES,	false },
 	{  "vote_no",		CONFIG2_VOTENO,		false },
	{  "letgainer",		CONFIG2_LETGAIN,	false },
	{  "no_song_mods",	CONFIG2_NOSONGMODS,     false },
	{  "shut_up",		CONFIG2_SHUTUP,     	false },
	{  "posing",		CONFIG2_POSING,     	false },
	{  "holycast",		CONFIG2_HOLYCAST,     	true  },
	{  "dunce",		CONFIG2_DUNCE,     	true  },
	{  "beholder_eye",	CONFIG2_BEHOLDER_EYE,	false	},
	{   NULL,       0,      true    }
};
/**************************************************************************/
const struct flag_type pconfig_flags[] =
{
	...
	{  "mountable",		PCONFIG_MOUNTABLE,	true},
	{   NULL,       0,      true    }
};
/**************************************************************************/
...
const struct flag_type commandflag_flags[] =
{
	...
	{	"no_stone_gargoyle",	CMD_NO_STONE_GARGOYLE,		true	},
	{	"no_stockade",		CMD_NO_STOCKADE,		true	},
	{	"no_werewolf",		CMD_NO_WEREWOLF,		true	},
	{	"no_vampform",		CMD_NO_VAMPFORM,		true	},
	{	"no_shadowplane",	CMD_NO_SHADOWPLANE,		true	},
	{	"while_crafting",	CMD_CRAFT,		true	},
	{	"no_holdperson",	CMD_NO_HOLDPERSON,		true	},
	{	NULL,			0,							false	}
};
...
const struct flag_type sector_desc[] =
{
	...
	{   "over the lava",		SECT_LAVA,			false   },
 	{   "at a gateway",		SECT_GATEWAY,			false   },
 	{   "in a vehicle",		SECT_VEHICLE,			false   },
	{	NULL,		0,					0	}
};
/**************************************************************************/
...
const struct flag_type style_flags[] = 
{
	{ "normal",		STYLE_NORMAL,		true},
	{ "aggresive",		STYLE_AGGRESSIVE,	true},
	{ "defensive",		STYLE_DEFENSIVE,	true},
	{ "evasive",		STYLE_EVASIVE,		true},
	{ NULL,0,0}
};

const struct flag_type wish_flags[] = 
{
	{ "none",			WISH_NONE,		false	},
	{ "darkvision",			WISH_DARKVISION,	true	},
	{ "scryproof",			WISH_SCRYPROOF,		true	},
	{ "hearing",			WISH_HEARING,		true	},
	{ "no_food",			WISH_IMMFOOD,		true	},
	{ "flying",			WISH_FLYING,		true	},
	{ "eatall",			WISH_EATALL,		true	},
	{ "otterlungs",			WISH_OTTERLUNGS,	true	},
	{ "regen",			WISH_REGEN,		true	},
	{ "sanctuary",			WISH_SANCTUARY,		true	},
	{ "cleanspeech",		WISH_CLEANSPEECH,	true	},
	{ "vicegrip",			WISH_VICEGRIP,		true	},
	{ "attack1",			WISH_ATTACK_1,		true	},
	{ "attack2",			WISH_ATTACK_2,		true	},
	{ "attack3",			WISH_ATTACK_3,		true	},
	{ NULL,				0,			0}
};

const struct flag_type crime_flags[] = 
{
	{ "murder",			CRIME_MURDER,		true	},
	{ "theft",			CRIME_THEFT,		true	},
	{ "weapons",			CRIME_WEAPONS,		true	},
	{ "assault",			CRIME_ASSAULT,		true	},
	{ "extortion",			CRIME_EXTORTION,	true	},
	{ "treason",			CRIME_TREASON,		true	},
	{ "bad_magic",			CRIME_BADMAGIC,		true	},
	{ "drunkeness",			CRIME_DRUNK,		true	},
	{ "bribery",			CRIME_BRIBE,		true	},
	{ "impersonation",		CRIME_IMPERSONATE,	true	},
	{ "vampirism",			CRIME_VAMPIRE,		true	},
	{ "werewolfism",		CRIME_WEREWOLF,		true	},
	{ "disease",			CRIME_DISEASE,		true	},
	{ "religion",			CRIME_RELIGION,		true	},
	{ "threats",			CRIME_THREATS,		true	},	
	{ "disturb_peace",		CRIME_DISTURB_PEACE,	true	},
	{ "blackmail",			CRIME_BLACKMAIL,	true	},
	{ "evade_law",			CRIME_EVADING_LAW,	true	},
	{ "necromancy",			CRIME_NECROMANCY,	true	},
	{ "on_trial",			CRIME_ONTRIAL,		true	},
	{ "dragonform",			CRIME_DRAGON,		true	},
	{ "undead",			CRIME_UNDEAD,		true	},
	{ NULL,				0,			0}
};
...
{
	{"none",		DAM_NONE,		false},
	{"battered ",		DAM_BASH,		false},
	{"gouged ",		DAM_PIERCE,		false},
	{"tattered ",		DAM_SLASH,		false},
	{"burnt ",		DAM_FIRE,		false},
	{"frozen ",		DAM_COLD,		false},
	{"blackened ",		DAM_LIGHTNING,		false},
	{"liquified ",		DAM_ACID,		false},
	{"sickly ",		DAM_POISON,		false},
	{"twisted ",		DAM_NEGATIVE,		false},
	{"pristine ",		DAM_HOLY,		false},
	{"charred ",		DAM_ENERGY,		false},
	{"mental",			DAM_MENTAL,		false},
	{"pox-ridden ",		DAM_DISEASE,		false},
	{"bloated ",		DAM_DROWNING,		false},
	{"charred ",		DAM_LIGHT,		false},
	{"",			DAM_OTHER,		false},
	{"rigid ",		DAM_HARM,		false},
	{"",			DAM_CHARM,		false},
	{"battered ",		DAM_SOUND,		false},
	{"",			DAM_ILLUSION,	false},
	{ NULL,			0,				   0}
};


const struct flag_type territory1_flags[] = 
{
	{ "guard",		TERRITORY_GUARD,		true	},
	{ "got_bonus",		SUPERBONUS,			false	},
	{ NULL,				0,			0}
};
...
/**************************************************************************/
const struct flag_type food_flags[] =
{
	{ "poisoned",				FOOD_POISONED,		true },
	{ "consecrated",			FOOD_CONSECRATED,	true },
	{ "juicy",				FOOD_JUICY,		true },
	{ NULL, 0, 0 }
};
/**************************************************************************/
...
/**************************************************************************/
const 	struct flag_type 	vehicle_flags[]		=
{
	{ "land",		VEHICLE_LAND,		true},
	{ "water",		VEHICLE_WATER,		true},
	{ "air",		VEHICLE_AIR, 		true},
	{ "underwater",		VEHICLE_UNDERWATER,	true},
	{ "lava",		VEHICLE_LAVA,		true},
	{ "caves",		VEHICLE_CAVE,		true},
	{ NULL, 0, 0 }
};
/**************************************************************************/
const 	struct flag_type 	firearm_flags[]		=
{
	{ "single_shot",	FIREARM_SINGLE,		true},
	{ "dual_shot",		FIREARM_DUAL,		true},
	{ "burst_shot",		FIREARM_BURST, 		true},
	{ "full_auto",		FIREARM_AUTO,		true},
	{ "recoil_none",	FIREARM_RECOIL_NONE,	true},
	{ "recoil_light",	FIREARM_RECOIL_LIGHT,	true},
	{ "recoil_heavy",	FIREARM_RECOIL_HEAVY,	true},
	{ "recoil_extreme",	FIREARM_RECOIL_EXTREME,	true},
	{ NULL, 0, 0 }
};
/**************************************************************************/
const 	struct flag_type 	pet_norm_flags[]		=
{
	{ "fetch",		PET_NORMTRICK_1,		true},
	{ "beg",		PET_NORMTRICK_2,		true},
	{ "roll_over",		PET_NORMTRICK_3, 		true},
	{ "shake",		PET_NORMTRICK_4,		true},
	{ "speak",		PET_NORMTRICK_5,		true},
	{ "jump_hoop",		PET_NORMTRICK_6,		true},
	{ "backflip",		PET_NORMTRICK_7,		true},
	{ "bury",		PET_NORMTRICK_8,		true},
	{ "hunt",		PET_NORMTRICK_9,		true},
	{ "hiss",		PET_NORMTRICK_10,		true},
	{ "freakout",		PET_NORMTRICK_11,		true},
	{ "sing",		PET_NORMTRICK_12,		true},
	{ "chase_tail",		PET_NORMTRICK_13,		true},
	{ "high_5",		PET_NORMTRICK_14,		true},
	{ "",		PET_NORMTRICK_15,		true},
	{ "",		PET_NORMTRICK_16,		true},
	{ "",		PET_NORMTRICK_17,		true},
	{ "",		PET_NORMTRICK_18,		true},
	{ "",		PET_NORMTRICK_19,		true},
	{ "",		PET_NORMTRICK_20,		true},
	{ "",		PET_NORMTRICK_21,		true},
	{ "",		PET_NORMTRICK_22,		true},
	{ "",		PET_NORMTRICK_23,		true},
	{ "",		PET_NORMTRICK_24,		true},
	{ "",		PET_NORMTRICK_25,		true},
	{ "",		PET_NORMTRICK_26,		true},
	{ "",		PET_NORMTRICK_27,		true},
	{ "",		PET_NORMTRICK_28,		true},
	{ "",		PET_NORMTRICK_29,		true},
	{ "",		PET_NORMTRICK_30,		true},
	{ "",		PET_NORMTRICK_31,		true},
	{ NULL, 		0, 			0   }
};
/**************************************************************************/
const 	struct flag_type 	pet_magic_flags[]		=
{
	{ "darkness",		PET_MAGICTRICK_1,		true},
	{ "glow",		PET_MAGICTRICK_2,		true},
	{ "teleport",		PET_MAGICTRICK_3, 		true},
	{ "start_fire",		PET_MAGICTRICK_4,		true},
	{ "dig_spring",		PET_MAGICTRICK_5,		true},
	{ "invis",		PET_MAGICTRICK_6,		true},
	{ "ball_light",		PET_MAGICTRICK_7,		true},
	{ "visable_fog",	PET_MAGICTRICK_8,		true},
	{ "",		PET_MAGICTRICK_9,		true},
	{ "",		PET_MAGICTRICK_10,		true},
	{ "",		PET_MAGICTRICK_11,		true},
	{ "",		PET_MAGICTRICK_12,		true},
	{ "",		PET_MAGICTRICK_13,		true},
	{ "",		PET_MAGICTRICK_14,		true},
	{ "",		PET_MAGICTRICK_15,		true},
	{ "",		PET_MAGICTRICK_16,		true},
	{ "",		PET_MAGICTRICK_17,		true},
	{ "",		PET_MAGICTRICK_18,		true},
	{ "",		PET_MAGICTRICK_19,		true},
	{ "",		PET_MAGICTRICK_20,		true},
	{ "",		PET_MAGICTRICK_21,		true},
	{ "",		PET_MAGICTRICK_22,		true},
	{ "",		PET_MAGICTRICK_23,		true},
	{ "",		PET_MAGICTRICK_24,		true},
	{ "",		PET_MAGICTRICK_25,		true},
	{ "",		PET_MAGICTRICK_26,		true},
	{ "",		PET_MAGICTRICK_27,		true},
	{ "",		PET_MAGICTRICK_28,		true},
	{ "",		PET_MAGICTRICK_29,		true},
	{ "",		PET_MAGICTRICK_30,		true},
	{ "",		PET_MAGICTRICK_31,		true},
	{ NULL, 		0, 			0   }
};
/**************************************************************************/
const 	struct flag_type 	craftquality_flags[]		=
{
	{ "evil",		QUALITY_EVIL,		true},
	{ "blessed",		QUALITY_BLESSED,		true},
	{ "chaos-riddled",		QUALITY_CHAOS, 		true},
	{ "heavy",		QUALITY_HEAVY,		true},
	{ "light",		QUALITY_LIGHT,		true},
	{ "durable",		QUALITY_DURABLE,		true},
	{ "fragile",		QUALITY_FRAGILE,		true},
	{ "transparent",	QUALITY_TRANSPARENT,		true},
	{ "dull",		QUALITY_DRAIN,		true},
	{ "cold",		QUALITY_SUCKLE,		true},
	{ "burnproof",	QUALITY_BURNPROOF,	true},
	{ "soft",		QUALITY_MALLEABLE,	true},
	{ "brittle",	QUALITY_BRITTLE,	true},
	{ "magical",	QUALITY_MAGICAL,	true},
	{ NULL, 		0, 			0   }
};
/**************************************************************************/
const 	struct material_type 	ore_table[]		=
{
	{ "iron",		ORE_IRON,		QUALITY_HEAVY }, 
	{ "silver",		ORE_SILVER,		QUALITY_BLESSED|QUALITY_MAGICAL|QUALITY_LIGHT   },
	{ "adamantium", ORE_ADAMANTIUM, QUALITY_EVIL|QUALITY_FRAGILE|QUALITY_DRAIN },
	{ "orchalicum",	ORE_ORCHALICUM,	QUALITY_MAGICAL|QUALITY_DURABLE|QUALITY_TRANSPARENT },
	{ "mithril",	ORE_MITHRIL,	QUALITY_MAGICAL|QUALITY_LIGHT|QUALITY_BURNPROOF },
	{ "copper",		ORE_COPPER,		QUALITY_MALLEABLE|QUALITY_FRAGILE },
	{ "steel",		ORE_STEEL,		QUALITY_HEAVY|QUALITY_DURABLE|QUALITY_BRITTLE },
	{ "gold",		ORE_GOLD,		QUALITY_MALLEABLE|QUALITY_HEAVY|QUALITY_FRAGILE },
	{ NULL,			0,				0}
};
...
{
			{ "none", 		0, 			true},
			{ "ore",	MATERIAL_ORE,	true}, 
			{ NULL, 		0, 			0   }
};
/**************************************************************************/
const   struct flag_type	corpse_conditional_flags[]	=
{
	{ "poisoned",		CORPSE_POISONED,	true},
	{ "plagued",		CORPSE_PLAGUED,		true},
	{ "mangled",		CORPSE_MANGLED,		true},
	{ "sealed",			CORPSE_SEALED,		true},
	{ NULL,				0,					true}
};
/**************************************************************************/
const   struct afteraff_type afteraff_table[] =
{
//	{ "affect name",	afteraffect_fun },				
	{ "raging fever",	afteraff_raging_fever }, //Werewolves
	{ "second wind",	afteraff_second_wind  }, //Imm only
	{ NULL,				NULL}
};
/**************************************************************************/
const	struct flag_type	dragon_types[]		=
{
	{ "steel",			DRAGON_STEEL,		true},
	{ "bronze",			DRAGON_BRONZE,		true},
	{ "brass",			DRAGON_BRASS,		true},
	{ "copper",			DRAGON_COPPER,		true},
	{ "gold",			DRAGON_GOLD,		true},
	{ "silver",			DRAGON_SILVER,		true},
	{ "blue",			DRAGON_BLUE,		true},
	{ "black",			DRAGON_BLACK,		true},
	{ "red",			DRAGON_RED,		true},
	{ "white",			DRAGON_WHITE,		true},
	{ "shadow",			DRAGON_SHADOW,		true},
	{ "cloud",			DRAGON_CLOUD,		true},
	{ "emerald",			DRAGON_EMERALD,		true},
	{ "green",			DRAGON_GREEN,		true},
	{	NULL,			0,					true}
};
/**************************************************************************/
const	struct flag_type	were_types[]		=
{
	{ "undecided",		WERE_NONE,			true},
	{ "werewolf",		WERE_WOLF,			true},
	{ "werebear",		WERE_BEAR,			true},
	{ "wererat",		WERE_RAT,			true},
	{ "wereboar",		WERE_BOAR,			true},
	{ "weretiger",		WERE_TIGER,			true},
	{ "werespider",		WERE_SPIDER,			true},
	{ "werecobra",		WERE_COBRA,			true},
	{ "werebat",		WERE_BAT,			true},
	{ "werecrocodile",	WERE_CROCODILE,			true},
	{	NULL,			0,					true}
};
/**************************************************************************/

const struct flag_type werebeast_flags[] = 
{
	{ "catseye",		WAFF_CATSEYE,		false	},
	{ "hibernation",	WAFF_HIBERNATION,	false	},
	{  NULL,	0,			0	}
};

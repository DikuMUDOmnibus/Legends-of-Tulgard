...
SPRESULT spell_holy_beam( int sn, int level, char_data *ch, void *vo, int  )
{
	...
	{
		act("$n summons forth a divine blast of pure night!",ch,NULL,NULL,TO_ROOM);
		ch->printf( "You summon forth a blast of pure night.\r\n" );
	...
	{
		act("$n summons forth a divine beam of energy!",ch,NULL,NULL,TO_ROOM);
		ch->printf( "You summon forth a beam of energy.\r\n" );
	...
	else
	{
		...
		{
			victim->printf( "You are blinded by a blast of darkness!\r\n" );
			act("$n appears to be badly blinded by a blast of darkness.",victim,NULL,NULL,TO_ROOM);
		}
		else
		{
			victim->printf( "You are blinded by a beam of energy!\r\n" );
			act("$n appears to be badly blinded by a beam of energy.",victim,NULL,NULL,TO_ROOM);
		}
...
/**************************************************************************/
SPRESULT spell_lions_roar( int sn, int level, char_data *ch, void *vo, int )
{
	char_data *victim = (char_data *) vo;
	AFFECT_DATA af;
	int dam;

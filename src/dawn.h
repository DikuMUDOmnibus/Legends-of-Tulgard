...
#define WHERE_VAMPIRE		12 // Vampire
#define WHERE_AFFECTS3		13
#define WHERE_WEREBEAST		14
...
#define ACT2_NOHUNT				(B)
#define ACT2_ALLSKILLS				(C)
#define ACT2_AVOIDS_ALL_ATTACKS 		(D)
#define ACT2_NO_TENDENCY			(E)
#define ACT2_DEALER				(F) // Ixliam
#define ACT2_PLR_CHALLENGED   			(G) // Ixliam
#define ACT2_PLR_CHALLENGER	 		(H) // Ixliam
#define ACT2_WAR_RED				(I) // Ixliam
#define ACT2_WAR_BLUE				(J) // Ixliam
#define ACT2_CRIME				(K) // Ixliam
#define ACT2_MURDER_5				(L) // Ixliam
#define ACT2_MURDER_10				(M) // Ixliam
#define ACT2_MURDER_25				(N) // Ixliam
#define ACT2_MURDER_50				(O) // Ixliam
#define ACT2_MURDER_100				(P) // Ixliam
#define ACT2_UNDERARREST			(Q) // Ixliam
#define ACT2_LICENSE_DEALER			(R) // Ixliam
#define ACT2_DECK_OF_FATE			(S) // Ixliam
#define ACT2_ALLOWEMBRACE			(T) // Ixliam
#define ACT2_ALLOWFEED				(U) // Ixliam
#define ACT2_REPAIRMAN				(V) // Ixliam
#define ACT2_FORGER				(W) // Ixliam
#define ACT2_COURTJUDGE				(X) // Ixliam
#define ACT2_NO_RANDOM_OBJ			(Y) // Ixliam
#define ACT2_LETTER_COURIER			(Z) // Ixliam
#define ACT2_KENNEL				(aa) // Ixliam
#define ACT2_EGGPET				(bb) // Ixliam	
#define ACT2_CLANMAKER				(cc) // Ixliam

#define CORPSE_DAM_NONE				(A)
#define CORPSE_DAM_BASH				(B)
#define CORPSE_DAM_PIERCE			(C)
#define CORPSE_DAM_SLASH			(D)
#define CORPSE_DAM_FIRE				(E)
#define CORPSE_DAM_COLD				(F)
#define CORPSE_DAM_LIGHTNING			(G)
#define CORPSE_DAM_ACID				(H)
#define CORPSE_DAM_POISON			(I)
#define CORPSE_DAM_NEGATIVE			(J)
#define CORPSE_DAM_HOLY				(K)
#define CORPSE_DAM_ENERGY			(L)
#define CORPSE_DAM_MENTAL			(M)
#define CORPSE_DAM_DISEASE 			(N)
#define CORPSE_DAM_DROWNING			(O)
#define CORPSE_DAM_LIGHT			(P)
#define CORPSE_DAM_OTHER			(Q)
#define CORPSE_DAM_HARM				(R)
#define CORPSE_DAM_CHARM			(S)
#define CORPSE_DAM_SOUND			(T)
#define CORPSE_DAM_ILLUSION			(U)
...
#define RES_SCRY				(bb)
#define RES_HUNGER				(cc) // Ixliam
#define	RES_THIRST				(dd) // Ixliam
#define	RES_FEAR				(ee) // Ixliam
...
#define VULN_SCRY				(bb)
#define VULN_HUNGER				(cc) // Ixliam
#define	VULN_THIRST				(dd) // Ixliam
#define	VULN_FEAR				(ee) // Ixliam
...
#define FORM_NON_SKINABLE 		(F)  // Ixliam
...
#define AFF2_NO_VAMP				(B) // Ixliam
#define AFF2_VAMP_BITE			(C)
#define AFF2_LYCANTHROPE		(D) // Ixliam
#define AFF2_STOCKADE			(E) // Ixliam
#define AFF2_FADE					(F)
#define AFF2_BAN_DECK			(G) // Ixliam
#define AFF2_SHAPESHIFT		   (H) // Ixliam
#define AFF2_SHADOWSIGHT		(I) // Ixliam
#define AFF2_NO_WEREWOLF		(J) // Ixliam
#define AFF2_NO_DISPEL 			(K)
#define AFF2_HIGHLANDER			(L) // Ixliam
#define AFF2_NO_HIGHLANDER		(M) // Ixliam
#define AFF2_MUTE			(N)
...
#define AFF2_ETHEREAL			(V) 
#define AFF2_SHADOWPLANE		(W)
#define AFF2_POLYMORPH			(X) // Ixliam
#define AFF2_HALLUCINATE		(Y) // Ixliam
#define AFF2_VICEGRIP			(Z)
#define AFF2_BOUNTYHUNTER		(aa) // Ixliam
#define AFF2_DESPAIR			(bb) // Ixliam
#define AFF2_DRAGON				(cc) // Ixliam
#define AFF2_STONE_GARGOYLE		(dd) // Ixliam
#define AFF2_PREGNANT			(ee) // Ixliam

// Bits for affected_by3
#define AFF3_DETECT_TAINT		(A)  //Reath

// Bits for 'titles'
#define TITLE_KING 		(A)
#define TITLE_QUEEN 		(B)
#define TITLE_DUKE		(C)
#define TITLE_DUCHESS		(D)
#define TITLE_BARON		(E)
#define TITLE_BARONESS		(F)
#define TITLE_LORD		(G)
#define TITLE_LADY		(H)
#define TITLE_SIR		(I)
#define TITLE_DAME		(J)
#define TITLE_PAGE		(K)
#define TITLE_SQUIRE		(L)
#define TITLE_MAYOR		(M)
#define TITLE_MARQUIS		(N)
#define TITLE_MARQUESTA		(O)
#define TITLE_COUNT		(P)
#define TITLE_COUNTESS		(Q)
#define TITLE_PRINCE		(R)
#define TITLE_PRINCESS		(S)
#define TITLE_CAPTAIN		(T)
#define TITLE_MAN_AT_ARMS	(U)
#define TITLE_JESTER		(V)
#define TITLE_PRIEST		(W)
#define TITLE_PRIESTESS		(X)
#define TITLE_MASTER		(Y)
#define TITLE_MISTRESS		(Z)
#define TITLE_ARCHMAGE		(aa)
#define TITLE_ACOLYTE		(bb)
#define TITLE_AMBASSADOR	(cc)
#define TITLE_GOVERNOR		(dd)
#define TITLE_APPRENTICE	(ee)

// Bits for 'vehicles'
#define VEHICLE_LAND          	(A)
#define VEHICLE_WATER          	(B)
#define VEHICLE_AIR     	(C)
#define VEHICLE_UNDERWATER     	(D)
#define VEHICLE_LAVA       	(E)
#define VEHICLE_CAVE       	(F)

// Bits for 'firearms'
#define FIREARM_SINGLE          (A)
#define FIREARM_DUAL          	(B)
#define FIREARM_BURST     	(C)
#define FIREARM_AUTO     	(D)
#define FIREARM_RECOIL_NONE     (E)
#define FIREARM_RECOIL_LIGHT    (F)
#define FIREARM_RECOIL_HEAVY	(G)
#define FIREARM_RECOIL_EXTREME	(H)

// Bits for 'pet norm tricks'
#define PET_NORMTRICK_1          	(A)
#define PET_NORMTRICK_2          	(B)
#define PET_NORMTRICK_3          	(C)
#define PET_NORMTRICK_4          	(D)
#define PET_NORMTRICK_5          	(E)
#define PET_NORMTRICK_6          	(F)
#define PET_NORMTRICK_7          	(G)
#define PET_NORMTRICK_8          	(H)
#define PET_NORMTRICK_9          	(I)
#define PET_NORMTRICK_10          	(J)
#define PET_NORMTRICK_11          	(K)
#define PET_NORMTRICK_12          	(L)
#define PET_NORMTRICK_13          	(M)
#define PET_NORMTRICK_14          	(N)
#define PET_NORMTRICK_15          	(O)
#define PET_NORMTRICK_16          	(P)
#define PET_NORMTRICK_17          	(Q)
#define PET_NORMTRICK_18          	(R)
#define PET_NORMTRICK_19          	(S)
#define PET_NORMTRICK_20          	(T)
#define PET_NORMTRICK_21          	(U)
#define PET_NORMTRICK_22          	(V)
#define PET_NORMTRICK_23          	(W)
#define PET_NORMTRICK_24          	(X)
#define PET_NORMTRICK_25          	(Y)
#define PET_NORMTRICK_26          	(Z)
#define PET_NORMTRICK_27          	(aa)
#define PET_NORMTRICK_28          	(bb)
#define PET_NORMTRICK_29          	(cc)
#define PET_NORMTRICK_30          	(dd)
#define PET_NORMTRICK_31          	(ee)

// Bits for 'pet magic tricks'
#define PET_MAGICTRICK_1          	(A)
#define PET_MAGICTRICK_2          	(B)
#define PET_MAGICTRICK_3          	(C)
#define PET_MAGICTRICK_4          	(D)
#define PET_MAGICTRICK_5          	(E)
#define PET_MAGICTRICK_6          	(F)
#define PET_MAGICTRICK_7          	(G)
#define PET_MAGICTRICK_8          	(H)
#define PET_MAGICTRICK_9          	(I)
#define PET_MAGICTRICK_10          	(J)
#define PET_MAGICTRICK_11          	(K)
#define PET_MAGICTRICK_12          	(L)
#define PET_MAGICTRICK_13          	(M)
#define PET_MAGICTRICK_14          	(N)
#define PET_MAGICTRICK_15          	(O)
#define PET_MAGICTRICK_16          	(P)
#define PET_MAGICTRICK_17          	(Q)
#define PET_MAGICTRICK_18          	(R)
#define PET_MAGICTRICK_19          	(S)
#define PET_MAGICTRICK_20          	(T)
#define PET_MAGICTRICK_21          	(U)
#define PET_MAGICTRICK_22          	(V)
#define PET_MAGICTRICK_23          	(W)
#define PET_MAGICTRICK_24          	(X)
#define PET_MAGICTRICK_25          	(Y)
#define PET_MAGICTRICK_26          	(Z)
#define PET_MAGICTRICK_27          	(aa)
#define PET_MAGICTRICK_28          	(bb)
#define PET_MAGICTRICK_29          	(cc)
#define PET_MAGICTRICK_30          	(dd)
#define PET_MAGICTRICK_31          	(ee)

// Bits for 'vampire'
#define VAM_FANGS          	(A)
#define VAM_CLAWS          	(B)
#define VAM_NIGHTSIGHT     	(C)
#define VAM_PROTEAN        	(D)
#define VAM_CELERITY       	(E)
#define VAM_FORTITUDE     	(F)
#define VAM_POTENCE        	(G)
#define VAM_OBFUSCATE      	(H)
#define VAM_AUSPEX         	(I)
#define VAM_OBTENEBRATION  	(J)
#define VAM_SERPENTIS      	(K)
#define VAM_DISGUISED      	(L)
#define VAM_PRINCE         	(M)
#define VAM_DOMINATE       	(N)
#define VAM_BRUJAH		(O)
#define VAM_ASSAMITE		(P)
#define VAM_CAPPADOCIAN		(Q)
#define VAM_GANGREL		(R)
#define VAM_MALKAVIAN		(S)
#define VAM_NOSFERATU		(T)
#define VAM_TOREADOR		(U)
#define VAM_TREMERE		(V)
#define VAM_VENTRUE		(W)
#define VAM_CAN_SIRE		(X)
#define VAM_BAT			(Y)
#define VAM_MIST		(Z)
#define VAM_WOLF		(aa)
#define VAM_HUMAN		(bb)
#define VAM_IMM_STAKE		(cc)
#define VAM_TRUESIGHT		(dd)
#define VAM_SNAKE		(ee)

// Bits for werebeasts (uses ->vampire)
#define WAFF_CATSEYE	 (A)
#define WAFF_HIBERNATION (B)
...
#define SICK_FEVER		(C)
#define SICK_FLU		(D)
#define SICK_COLDSORE		(E)
#define SICK_POX		(F)
#define SICK_BLACKDEATH		(G)
#define SICK_LEPER		(H)
#define SICK_VOMIT		(I)
#define SICK_COUGH		(J)
#define SICK_ITCH		(K)
...
// Bits for 'styles'
#define STYLE_NORMAL		(A)
#define STYLE_AGGRESSIVE	(B)
#define STYLE_DEFENSIVE		(C)
#define STYLE_EVASIVE		(D)

// Bits for wishes
#define WISH_NONE		 0
#define WISH_DARKVISION		(A)
#define WISH_SCRYPROOF		(B)
#define WISH_HEARING		(C)
#define WISH_IMMFOOD		(D)
#define WISH_FLYING		(E)
#define WISH_EATALL		(F)
#define WISH_OTTERLUNGS		(G)
#define WISH_REGEN		(H)
#define WISH_SANCTUARY		(I)
#define WISH_CLEANSPEECH	(J)
#define WISH_VICEGRIP		(K)
#define WISH_ATTACK_1		(L)
#define WISH_ATTACK_2		(M)
#define WISH_ATTACK_3		(N)

// Bits for generic crimes
#define CRIME_MURDER		(A)
#define CRIME_THEFT		(B)
#define CRIME_WEAPONS		(C)
#define CRIME_ASSAULT		(D)
#define CRIME_EXTORTION		(E)
#define CRIME_TREASON		(F)
#define CRIME_BADMAGIC		(G)
#define CRIME_DRUNK		(H)
#define CRIME_BRIBE		(I)
#define CRIME_IMPERSONATE	(J)
#define CRIME_VAMPIRE		(K)
#define CRIME_WEREWOLF		(L)
#define CRIME_DISEASE		(M)
#define CRIME_RELIGION		(N)
#define CRIME_THREATS		(O)			
#define CRIME_DISTURB_PEACE	(P)
#define CRIME_BLACKMAIL		(Q)
#define CRIME_EVADING_LAW	(R)
#define CRIME_NECROMANCY	(S)
#define CRIME_ONTRIAL		(T)
#define CRIME_DRAGON		(U)
#define CRIME_UNDEAD		(V)

// Bits for territories
#define TERRITORY_GUARD		(A)
#define SUPERBONUS		(B)
...
#define ITEM_SLOTMACHINE	41 // Ixliam
#define ITEM_TABAC_PIPE		42 // Ixliam
#define ITEM_POLE		43 // Ixliam
#define ITEM_PROJECTILE		44 // Ixliam
#define ITEM_QUIVER		45 // Ixliam
#define ITEM_PIECE		46 // Ixliam
#define ITEM_VEHICLE		47 // Ixliam
#define ITEM_VEHICLE_CONTROLS	48 // Ixliam
#define ITEM_VEHICLE_WINDOW	49 // Ixliam
#define ITEM_VEHICLE_EXIT	50 // Ixliam
#define ITEM_HIDE		51 // Ixliam
#define ITEM_RUNE		52 // Ixliam
#define ITEM_AMMO		53 // Ixliam
#define ITEM_FIREARM		54 // Ixliam
#define ITEM_STARGATE           55 // Ixliam
#define ITEM_ORE		56
...
#define OBJEXTRA2_SHADOWPLANE 		(Q) // Ixliam
#define OBJEXTRA2_NON_SKINABLE 		(R) // Ixliam
#define OBJEXTRA2_PC_CRAFTED 		(S) // Ixliam
#define OBJEXTRA2_RUNIC 		(T) // Ixliam
#define OBJEXTRA2_NOIDENTIFY	(U) // Reath
#define OBJEXTRA2_REGROWING		(V) // Reath
#define OBJEXTRA2_TINKERED		(W)
...
#define ROOM2_SALTWATER_FISH	(C) // Ixliam
#define ROOM2_FRESHWATER_FISH	(D) // Ixliam
#define ROOM2_ARENA		(E) // Ixliam
#define ROOM2_WAR		(F) // Ixliam
#define ROOM2_NO_SHADOWPLANE 	(G) // Ixliam
#define ROOM2_TERR_1		(H) // Ixliam
#define ROOM2_TERR_2		(I) // Ixliam
#define ROOM2_TERR_3		(J) // Ixliam
#define ROOM2_TERR_4		(K) // Ixliam
#define ROOM2_TERR_5		(L) // Ixliam
#define ROOM2_TERR_6		(M) // Ixliam
#define ROOM2_TERR_7		(N) // Ixliam
#define ROOM2_TERR_8		(O) // Ixliam
#define ROOM2_TERR_9		(P) // Ixliam
#define ROOM2_TERR_10		(Q) // Ixliam
#define ROOM2_STORAGE		(R) // Ixliam
#define ROOM2_NOCLAN		(S) // Ixliam
#define ROOM2_PLAYER_SHOP	(T) // Ixliam
#define ROOM2_PC_SHOP_STORAGE	(U) // Ixliam
#define ROOM2_NOSTEAL		(V) // Ixliam
#define ROOM2_SHADOWPLANED  (W) // Reath
...
#define	SECT_LAVA			16
#define SECT_GATEWAY			17 // Ixliam
#define SECT_VEHICLE			18 // Ixliam
#define SECT_MAX			19

// Terrain restricts for mobs - Ixliam
#define TERR_INSIDE			(A)
#define TERR_CITY			(B)
#define TERR_FIELD			(C)
#define TERR_FOREST			(D)
#define TERR_HILLS			(E)
#define TERR_MOUNTAIN			(F)
#define TERR_WATER_SWIM			(G)
#define TERR_WATER_NOSWIM		(H)
#define TERR_SWAMP			(I)
#define TERR_AIR			(J)
#define TERR_DESERT			(K)
#define TERR_CAVE			(L)
#define TERR_UNDERWATER			(M)
#define TERR_SNOW			(N)
#define TERR_ICE			(O)
#define TERR_TRAIL			(P)
#define	TERR_LAVA			(Q)
...
#define WEAR_BACK           31
#define WEAR_2WIELD		32 // Ixliam
#define WEAR_2HOLD		33 // Ixliam
#define WEAR_2SECONDARY		34 // Ixliam
#define MAX_WEAR			35


//quality_flags
#define QUALITY_EVIL			(A)
#define QUALITY_BLESSED			(B)
#define QUALITY_CHAOS			(C)
#define QUALITY_HEAVY			(D)
#define QUALITY_LIGHT			(E)
#define QUALITY_DURABLE			(F)
#define QUALITY_FRAGILE			(G)
#define QUALITY_TRANSPARENT		(H)
#define QUALITY_DRAIN			(I)
#define QUALITY_SUCKLE			(J)
#define QUALITY_BURNPROOF		(K)
#define QUALITY_MALLEABLE		(L)
#define QUALITY_BRITTLE			(M)
#define QUALITY_MAGICAL			(N)
...
#define			TEDIT_NONE		 0
#define			TEDIT_CHANGED		(A)		// Autosave notification
...
#define CMD_NO_WEREWOLF				(H)
#define CMD_NO_VAMPFORM				(I)
#define CMD_NO_SHADOWPLANE			(J)
#define CMD_CRAFT				(K)
#define CMD_NO_HOLDPERSON			(L)
...
extern		bool			arena_is_busy;
extern		bool			is_challenge;
extern		int			challenge_tme;
...
#define DYN_QUESTING			(B) // player questing
...
#define DYN_SMOKING				(ee) // Ixliam

#define DYN2_DOING_SPINBLOCK			(A) //Reath
#define DYN2_DOING_ORBIT				(B) //Reath
#define DYN2_BLUFF_STRONG				(C) //Reath
#define DYN2_BLUFF_WEAK					(D) //Reath
#define DYN2_CHICANERY					(E) //Reath
#define DYN2_EVADING					(F) //Reath
...
#define CONFIG2_CONCEALED			(Q) // Ixliam
#define CONFIG2_CLOAKED				(R) // Ixliam
#define CONFIG2_FISHING				(S) // Ixliam
#define CONFIG2_FISH_ON				(T) // Ixliam
#define CONFIG2_JUDGE				(U) // Ixliam
#define CONFIG2_SHEATHED			(V) // Ixliam
#define CONFIG2_VOTEYES				(W) // Ixliam
#define CONFIG2_VOTENO				(X) // Ixliam
#define CONFIG2_LETGAIN				(Y) // Ixliam
#define CONFIG2_NOSONGMODS			(Z) // Ixliam
#define CONFIG2_SHUTUP				(aa) // Ixliam
#define CONFIG2_POSING				(bb) // Ixliam
#define CONFIG2_HOLYCAST			(cc) //Reath
#define CONFIG2_DUNCE				(dd) //Reath
#define CONFIG2_BEHOLDER_EYE			(ee) // Ixliam

// pconfig flags
#define PCONFIG_FILLER				(A) // does nothing
#define PCONFIG_MOUNTABLE			(B) // allows themselves to be mounted
// sayflags
...
/**************************************************************************/
// ATTUNE defines
#define FOOD_POISONED		(A)			// if set food\drink is poisoned
#define FOOD_CONSECRATED	(B)			// if set food\drink is consecrated
#define FOOD_JUICY		(C)	//Ixliam
...
extern  const   struct  projectile_type     projectile_table    [];
...
extern	const	struct	territory_type		territory_table		[MAX_TERRITORY];
...
// Flags for missile weapons - Ixliam
#define      PROJ_ARROW       	1
#define      PROJ_BOLT      	2
#define      PROJ_DART  	3
#define	     PROJ_STONE      	4
...
#define		ORE_IRON			A
#define		ORE_SILVER			B
#define		ORE_ADAMANTIUM		C
#define		ORE_ORCHALICUM		D
#define		ORE_MITHRIL			E
#define		ORE_COPPER			F
#define		ORE_STEEL			G
#define		ORE_GOLD			H
/**************************************************************************/
//Craft material types
#define		MATERIAL_ORE		1
/**************************************************************************/
//Corpse Conditions
#define		CORPSE_POISONED		A
#define		CORPSE_PLAGUED		B
#define		CORPSE_MANGLED		C
#define		CORPSE_SEALED		D
/**************************************************************************/
//Alternate Form types
#define		ALTTYPE_LYCANTHROPE	1
#define		ALTTYPE_DRAGONFORM	2
/**************************************************************************/
//Dragon subtypes
#define		DRAGON_COPPER		1
#define		DRAGON_SILVER		2
#define		DRAGON_GOLD		3
#define		DRAGON_BRONZE		4
#define		DRAGON_BRASS		5
#define		DRAGON_RED		6
#define		DRAGON_BLUE		7
#define		DRAGON_GREEN		8
#define		DRAGON_BLACK		9
#define		DRAGON_WHITE		10
#define		DRAGON_CRYSTAL		11
#define		DRAGON_STEEL		12
#define		DRAGON_SHADOW		13
#define		DRAGON_EMERALD		14
#define		DRAGON_CLOUD		15
/**************************************************************************/
#define		WERE_NONE		0
#define		WERE_WOLF		1
#define		WERE_BEAR		2
...
#define		WERE_COBRA		6
#define		WERE_BAT		7
#define		WERE_CROCODILE	        8
#define		WERE_SPIDER		9 //since it doesn't exist, it needs to be last
/**************************************************************************/
/**************************************************************************/
/**************************************************************************/

...
extern	const	struct	flag_type		crime_flags[];
...
extern	const	struct	flag_type		firearm_flags[];
extern	const	struct	flag_type		food_flags[];
...
extern	const	struct	flag_type		pet_norm_flags[];
extern	const	struct	flag_type		pet_magic_flags[];
extern	const	struct	flag_type		plr_flags[];
extern	const	struct	flag_type		portal_flags[];
extern	const	struct	flag_type		position_flags[];
extern	const	struct	flag_type		position_types[];
extern	const	struct	flag_type		preference_types[];
extern	const	struct	flag_type		projectile_class_types[];
...
extern	const	struct	flag_type		style_flags[];
extern	const	struct	flag_type		target_types[];
extern	const	struct	flag_type		tendency_flags[];
extern	const	struct	flag_type		territory1_flags[];
extern	const	struct	flag_type		terr_restrict_flags[];
...
extern	const	struct	flag_type		title_flags[];
extern	const	struct	flag_type		vampire_flags[];
extern	const	struct	flag_type		werebeast_flags[];
extern	const	struct	flag_type		vehicle_flags[];
...
extern	const	struct	flag_type		wish_flags[];
extern	const	struct	flag_type		wiznet_flags[];
extern	const	struct	flag_type 		craftquality_flags[];
extern  const   struct  flag_type		corpse_condition_flags[];
extern	const	struct	flag_type		dragon_types[];
extern	const	struct	flag_type		were_types[];
extern	const	struct	gamble_type 	gamble_table[];
extern	const	struct	position_type	position_table[];
extern	const	struct	sector_type 	sect_table[];
extern	const	struct	sex_type		sex_table[];
extern	const	struct	size_type		size_table[];
extern	const	struct	material_type 	ore_table[];
extern	const	struct	flag_type		material_types[];
extern  const   struct  afteraff_type   afteraff_table[];
#endif // TABLES_H

...
void init_map_tables(){
	...
	sector_table[SECT_TRAIL		]='o';
    sector_table[SECT_LAVA		]='@';
	sector_table[SECT_GATEWAY	]='O';
	sector_table[SECT_VEHICLE	]='H';
	...
	sector_colour[SECT_GATEWAY	]='M';
	sector_colour[SECT_VEHICLE	]='c';
...
void do_map(char_data *ch, char *)
{
	...
	if(!HAS_HOLYLIGHT(ch) && !IS_VAMPAFF(ch,VAM_NIGHTSIGHT) && !IS_AFFECTED(ch, AFF_DARK_VISION)){

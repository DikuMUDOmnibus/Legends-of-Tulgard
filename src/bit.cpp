...
//	{	structure, text version				type	}, 
    ...
    {   STNM(corpse_flags),					false   },
    {   STNM(crime_flags),					false   },
    {   STNM(wish_flags),					false   },
    {   STNM(dedit_flags),					false   },
    {   STNM(exit_flags),					false   },
    {   STNM(food_flags),					false   },
    ...
    {   STNM(title_flags),					false   },
    {   STNM(tendency_flags),				false   },
    {   STNM(territory1_flags),				false   },
    {   STNM(vampire_flags),				false   },
    {   STNM(werebeast_flags),				false   },

...
bool raceedit_show( char_data *ch, char * )
{
	...
	if(tab==0){ // general
		...
		ch->print_blank_lines(1); 
		mxp_display_olc_flags(ch, terr_restrict_flags,	r->terr_restrict,	"terr",		"Terrain Restricts:");
...
/**************************************************************************/
bool raceedit_territory(char_data *ch, char *argument)
{
	return raceedit_flagtoggle(ch, argument, 
		terr_restrict_flags, "Terrain Restricts",R_OFFSET(terr_restrict), 
		"terr", "terr", 2);
}
/**************************************************************************/

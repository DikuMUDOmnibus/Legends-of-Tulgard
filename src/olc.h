...
void	craftedit		args( ( char_data *ch, char *argument ) );
// OLC Constants
...
TERRITORY_DATA *new_territory( void );
...
#define EDIT_TERRITORY(Ch, Territory)	( Territory = (TERRITORY_DATA *)Ch->desc->pEdit )

...
const struct item_type item_table [] =
{
	...
	{ ITEM_ORE,			"ore"			},
	{ ITEM_SLOTMACHINE, 	"slotmachine" 		},
 	{ ITEM_TABAC_PIPE, 	"tabac_pipe" 		},
 	{ ITEM_QUIVER, 		"quiver" 		},
 	{ ITEM_PROJECTILE, 	"projectile" 		},
	{ 0,         NULL					}
};

const struct projectile_type projectile_table [] =
{
	{ 0, 			"none"		},
	{ PROJ_ARROW,		"arrow"		},
	{ PROJ_BOLT,		"bolt"		},
...
const   struct  weapon_type     weapon_table    []      =
{
	...
	{ "bow",	GETBYTE_OFFSET(obj_vnum_outfit_sword),	WEAPON_BOW,	&gsn_bow		},
	{ "blowgun",	GETBYTE_OFFSET(obj_vnum_outfit_dagger),	WEAPON_BLOWGUN,	&gsn_blowgun		},
	{ "sling",	GETBYTE_OFFSET(obj_vnum_outfit_mace),	WEAPON_SLING,	&gsn_sling		},
	{ "crossbow",	GETBYTE_OFFSET(obj_vnum_outfit_sword),	WEAPON_CROSSBOW,&gsn_bow		},
	{ NULL,		0,	0,	NULL	}
};
...
const   struct attack_type      attack_table    []              =
{
	...
	{	"vibration",	"vibrations",	DAM_SOUND		},  // 44
	{   "wither",		"withering",	DAM_HARM		},  // 45
	{	"disease",		"sickness",		DAM_OTHER		},  // 46
	{	"hunger",		"ravenous aura",DAM_OTHER		},  // 47
	{	"thirst",		"wilting aura",	DAM_OTHER		},  // 48

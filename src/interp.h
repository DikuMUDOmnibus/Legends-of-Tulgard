...
DECLARE_DO_FUN( do_war_red );
DECLARE_DO_FUN( do_war_blue );
DECLARE_DO_FUN( do_war_leave);
DECLARE_DO_FUN( do_arrest);
DECLARE_DO_FUN( do_license );
DECLARE_DO_FUN( do_startprison );
DECLARE_DO_FUN( do_endprison );
DECLARE_DO_FUN( do_pardon );
DECLARE_DO_FUN( do_convict );
DECLARE_DO_FUN( do_pulldeck);
DECLARE_DO_FUN( do_deckban);
...
DECLARE_DO_FUN( do_werechange);
DECLARE_DO_FUN( do_werebeast);
DECLARE_DO_FUN( do_vampire);
DECLARE_DO_FUN( do_vampchange);
DECLARE_DO_FUN( do_dragonchange);
DECLARE_DO_FUN( vampgen);
DECLARE_DO_FUN( do_embrace );
DECLARE_DO_FUN( do_feed );
DECLARE_DO_FUN( do_empower );
DECLARE_DO_FUN( do_allowfeed );
DECLARE_DO_FUN( do_allowembrace );
DECLARE_DO_FUN( do_make_bag );
DECLARE_DO_FUN( do_wolf_call );
DECLARE_DO_FUN( do_vampdestroy );
DECLARE_DO_FUN( do_hypnotize );
DECLARE_DO_FUN( do_vampfear );
DECLARE_DO_FUN( do_stake );
DECLARE_DO_FUN( do_removeactive );
DECLARE_DO_FUN( do_omni );
DECLARE_DO_FUN( do_wereshort );
DECLARE_DO_FUN( do_wolfdesc );
DECLARE_DO_FUN( do_decapitate );
DECLARE_DO_FUN( do_triwield );
DECLARE_DO_FUN( do_quadwield );
DECLARE_DO_FUN( do_insect );
DECLARE_DO_FUN( do_heretic );
DECLARE_DO_FUN( do_patron );
DECLARE_DO_FUN( do_offering );
DECLARE_DO_FUN( do_shrine );
DECLARE_DO_FUN( do_mtsteal );
DECLARE_DO_FUN( do_use );
DECLARE_DO_FUN( do_mindspeak );
DECLARE_DO_FUN( do_crestset );
DECLARE_DO_FUN( do_randtest );
DECLARE_DO_FUN( do_restring );
DECLARE_DO_FUN( do_repair );
DECLARE_DO_FUN( do_evaluate );
DECLARE_DO_FUN( do_forge );
DECLARE_DO_FUN( do_relogin );
DECLARE_DO_FUN( do_accuse );
DECLARE_DO_FUN( do_stockade );
...
DECLARE_DO_FUN( do_topcrime );
DECLARE_DO_FUN( do_toparena );
DECLARE_DO_FUN( do_quest );
DECLARE_DO_FUN( do_vampclan );
...
DECLARE_DO_FUN( do_journey );
DECLARE_DO_FUN( do_shadowplane );
DECLARE_DO_FUN( do_shadowsight );
DECLARE_DO_FUN( do_favor );
DECLARE_DO_FUN( do_makedoll );
DECLARE_DO_FUN( do_voodoo );
DECLARE_DO_FUN( do_torpor );
DECLARE_DO_FUN( do_shapeshift );
DECLARE_DO_FUN( do_highlander );
DECLARE_DO_FUN( do_buzz );
DECLARE_DO_FUN( do_saveterritory );
DECLARE_DO_FUN( do_tedit );
DECLARE_DO_FUN( do_guard );
DECLARE_DO_FUN( do_laws );
DECLARE_DO_FUN( do_quazer );
DECLARE_DO_FUN( do_wishgrant );
DECLARE_DO_FUN( do_event );
DECLARE_DO_FUN( do_fealty );
DECLARE_DO_FUN( do_knight );
DECLARE_DO_FUN( do_entitle );
DECLARE_DO_FUN( do_squire );
DECLARE_DO_FUN( do_bharrest );
DECLARE_DO_FUN( do_sendletter );
DECLARE_DO_FUN( do_pigeonlist );
DECLARE_DO_FUN( do_pigeonremove );
DECLARE_DO_FUN( do_checkletter );
DECLARE_DO_FUN( do_purgearea );
DECLARE_DO_FUN( do_qdraw );
DECLARE_DO_FUN( do_fire );
DECLARE_DO_FUN( do_pregnant );
DECLARE_DO_FUN( do_connect );
DECLARE_DO_FUN( do_board );
DECLARE_DO_FUN( do_drive );
DECLARE_DO_FUN( do_vehicle_delete );
DECLARE_DO_FUN( do_impslay );
DECLARE_DO_FUN( do_vehiclelist );
DECLARE_DO_FUN( do_vehicle_add );
DECLARE_DO_FUN( do_kennel );
DECLARE_DO_FUN( do_pet );
DECLARE_DO_FUN( do_mine );
DECLARE_DO_FUN( do_smithweapon );
DECLARE_DO_FUN( do_smitharmor );
DECLARE_DO_FUN( do_repair_armor );
DECLARE_DO_FUN( do_repair_weapon );
DECLARE_DO_FUN( do_skinhide );
DECLARE_DO_FUN( do_leathercraft );
DECLARE_DO_FUN( do_price );
DECLARE_DO_FUN( do_superboon );
DECLARE_DO_FUN( do_voteclan );
DECLARE_DO_FUN( do_foundclan );
DECLARE_DO_FUN( do_whoclan );
DECLARE_DO_FUN( do_rankclan );
DECLARE_DO_FUN( do_disbandclan );
DECLARE_DO_FUN( do_pcletgainer );
DECLARE_DO_FUN( do_pcshort );
DECLARE_DO_FUN( do_pcdeclineletgain );
DECLARE_DO_FUN( do_pcofflineletgain );
DECLARE_DO_FUN( do_pclistletgains );
DECLARE_DO_FUN( do_pcunletgain );
DECLARE_DO_FUN( do_pcletgain );
DECLARE_DO_FUN( do_createnewpc );
DECLARE_DO_FUN( do_gmote );
DECLARE_DO_FUN( do_scatter );
DECLARE_DO_FUN( do_dreamtest );
DECLARE_DO_FUN( do_songrecite );
DECLARE_DO_FUN( do_songcraft );
DECLARE_DO_FUN( do_disallowsongs );
DECLARE_DO_FUN( do_shutup );
DECLARE_DO_FUN( do_posmote );
DECLARE_DO_FUN( do_spinblock );
DECLARE_DO_FUN( do_bluff );
DECLARE_DO_FUN( do_chicanery );
DECLARE_DO_FUN( do_orbit );
DECLARE_DO_FUN( do_dunce );
DECLARE_DO_FUN( do_weaponsmith );
DECLARE_DO_FUN( do_oswhere );
DECLARE_DO_FUN( do_materialcheck );
DECLARE_DO_FUN( do_infect );
DECLARE_DO_FUN( do_shoot );
DECLARE_DO_FUN( do_reload );
DECLARE_DO_FUN( do_stargate );
DECLARE_DO_FUN( do_mountable );
DECLARE_DO_FUN( do_allowinfect );
DECLARE_DO_FUN( do_tinker );
DECLARE_DO_FUN( do_reinforce );
DECLARE_DO_FUN( do_buck );
DECLARE_DO_FUN( do_ignore );
DECLARE_DO_FUN( do_bite	);
DECLARE_DO_FUN( do_eyepower );
DECLARE_DO_FUN( do_antimagiceye );
DECLARE_DO_FUN( do_display );
DECLARE_DO_FUN( do_evade );
DECLARE_DO_FUN( do_reremort );

...
#define IS_SKILL(sn)		((sn >= gsn_claw) && (sn <= gsn_undercommon ))
...
#define IS_VAMPAFF(ch, bit)   	((IS_VAMPIRE((ch)) || (!IS_WEREBEAST((ch)) && IS_SET((ch)->vampire, VAM_HUMAN)))&& IS_SET((ch)->vampire, (bit)))
#define IS_WEREAFF(ch, bit)   	(IS_WEREBEAST((ch)) && IS_SET((ch)->vampire, (bit)))
#define SET_WEREAFF(ch, bit)    (SET_BIT((ch)->vampire, (bit)))
#define SET_VAMPAFF(ch, bit)    (SET_BIT((ch)->vampire, (bit)))
#define REMOVE_WEREAFF(ch, bit)    (REMOVE_BIT((ch)->vampire, (bit)))
#define REMOVE_WEREAFF(ch, bit)    (REMOVE_BIT((ch)->vampire, (bit)))
...
// Ixliam
#define IS_OLD_WEREWOLF(ch)	(IS_AFFECTED2(ch, AFF2_LYCANTHROPE))
#define IS_WEREWOLF(ch)		(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_WOLF)
#define IS_WEREBEAR(ch)		(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_BEAR)
#define IS_WERERAT(ch)		(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_RAT)
#define IS_WEREBOAR(ch)		(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_BOAR)
#define IS_WERETIGER(ch)	(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_TIGER)
#define IS_WERESPIDER(ch)	(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_SPIDER)
#define IS_WERECOBRA(ch)	(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_COBRA)
#define IS_WEREBAT(ch)		(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_BAT)
#define IS_WERECROCODILE(ch)	(IS_AFFECTED2(ch, AFF2_LYCANTHROPE) && ch->altform.subtype == WERE_CROCODILE)

#define IS_WEREBEAST(ch)	(IS_AFFECTED2(ch, AFF2_LYCANTHROPE)) 
#define IS_VAMPIRE(ch)		(IS_AFFECTED2(ch, AFF2_VAMP_BITE)) 
#define IS_DRAGON(ch)		(IS_SET(race_table[ch->race]->form, FORM_DRAGON))
#define IS_WEREFORM(ch)		(IS_WEREBEAST(ch) && ch->altformed == true) 
#define IS_DRAGONFORM(ch)	(IS_DRAGON(ch) && ch->altformed == true)

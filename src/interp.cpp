...

{
	...
	*/	
	...
	{ "allowinfect",	do_allowinfect,		POS_STANDING,	0,	LOG_NORMAL, 	1 },
	...
	{ "bluff",			do_bluff,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
...
//	{ "bypassduel", 	do_bypassduel,		POS_RESTING,	0,	LOG_ALWAYS, 	1 },
	...
	{ "chicanery",		do_chicanery,		POS_DEAD,		0,	LOG_NORMAL, 	1 },
	...
	{ "dunce",		 	do_dunce,			POS_DEAD,		L7,	LOG_ALWAYS, 	1 },
	...
	{ "evade",			do_evade,			POS_DEAD,		0,	LOG_NORMAL, 	1 },
	...
	{ "gamble", 		do_game,			POS_SITTING,	0,	LOG_ALWAYS, 	1 },
...
//	{ "helphistory",	do_helphistory,		POS_DEAD,		0,	LOG_NORMAL, 	1 },
	...
	{ "infect",		 	do_infect,			POS_FIGHTING,	0,	LOG_NORMAL, 	1 },
	...
	{ "treasury",		do_lockers,			POS_RESTING,	0,	LOG_ALWAYS, 	0 },
	...
	{ "oswhere", 		do_oswhere,			POS_DEAD,	   IM,	LOG_NORMAL, 	1 },
	...
	{ "reinforce",		do_reinforce,		POS_STANDING,	0,	LOG_NORMAL, 	1 },
	...
	{ "tinker",		 	do_tinker,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
...
//	Putting Weapon skills down here so they don't interfere with other commands
	{ "boneshatter",	do_boneshatter, 	POS_FIGHTING,	0,  LOG_ALWAYS,	0 },
	{ "charge", 		do_charge,			POS_STANDING,	0,  LOG_ALWAYS,	0 },
	{ "conceal",		do_conceal, 		POS_RESTING,	0,	  LOG_ALWAYS,	0 },
	{ "cutoff", 		do_cutoff,			POS_FIGHTING,	0,  LOG_ALWAYS,	0 },
	{ "dervish",		do_dervish, 		POS_FIGHTING,	0,  LOG_ALWAYS,	0 },
	{ "entangle",		do_entangle,		POS_FIGHTING,	0,  LOG_ALWAYS,	0 },
	{ "hobble", 		do_hobble,			POS_FIGHTING,	0,  LOG_ALWAYS,	0 },
	{ "hurl",			do_hurl,			POS_FIGHTING,	0,  LOG_ALWAYS,	0 },
	{ "overhead",		do_overhead,		POS_FIGHTING,	IM,  LOG_ALWAYS,	0 },
	{ "shieldcleave",	do_shieldcleave,	POS_FIGHTING,	0,  LOG_ALWAYS,	0 },
	{ "vault",			do_vault,			POS_FIGHTING,	0,  LOG_ALWAYS,	0 },
	{ "spinblock",		do_spinblock, 		POS_FIGHTING,	0,	  LOG_ALWAYS,	0 },
	{ "orbit",			do_orbit,			POS_FIGHTING,	0,	LOG_ALWAYS, 	0 },
...
// New Stuff By Ixliam
	{ "purchase", 		do_forge,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "repair", 		do_repair,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "evaluate", 		do_evaluate,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "smoke", 		do_smoke,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "exhale", 		do_exhale,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "think",		do_think,			POS_DEAD,	0,	LOG_NORMAL, 	1 },
	{ "wizzap",		do_wizzap,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },
	{ "home",		do_home,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "smite",		do_smite,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },
	{ "castout", 		do_castout,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "reelin", 		do_reelin,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "challenge", 		do_challenge,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "arenayes", 		do_accept,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "arenano", 		do_decline,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "withdraw", 		do_withdraw,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "arenareset",		do_resetarena,			POS_DEAD,	IM,	LOG_NORMAL, 	1 },
	{ "warred", 		do_war_red,			POS_STANDING,	6,	LOG_NORMAL, 	1 },
	{ "warblue", 		do_war_blue,			POS_STANDING,	6,	LOG_NORMAL, 	1 },
	{ "warleave", 		do_war_leave,			POS_STANDING,	6,	LOG_NORMAL, 	1 },
	{ "arrest", 		do_arrest,			POS_STANDING,	6,	LOG_NORMAL, 	1 },
	{ "bharrest", 		do_bharrest,			POS_STANDING,	6,	LOG_NORMAL, 	1 },
	{ "license", 		do_license,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "pardon",		do_pardon,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },	
	{ "convict",		do_convict,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },	
	{ "pull", 		do_pulldeck,			POS_STANDING,	10,	LOG_NORMAL, 	1 },
	{ "deckban",		do_deckban,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },
	{ "crush",		do_crush,			POS_FIGHTING,	0,	LOG_NORMAL, 	1 },
	{ "mphunt",		do_mphunt,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },
	{ "bandage",		do_bandage,			POS_RESTING,	0,	LOG_NORMAL, 	1 },	
	{ "impale", 		do_impale,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "shrink", 		do_shrink,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "werechange", 	do_werechange,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "werebeast",		do_werebeast,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },	
	{ "favor", 		do_favor,			POS_STANDING,	L1,	LOG_NORMAL, 	1 },
	{ "vampchange", 	do_vampchange,			POS_STANDING,	L1,	LOG_NORMAL, 	1 },
	{ "vampire",		do_vampire,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },	
	{ "dragonchange", 	do_dragonchange,		POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "vampgen",		vampgen,			POS_DEAD,	ML+1,	LOG_ALWAYS, 	1 },	
	{ "vampdestroy",	do_vampdestroy,			POS_STANDING,	30,	LOG_ALWAYS, 	1 },	
	{ "embrace", 		do_embrace,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "feed", 		do_feed,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "empower", 		do_empower,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "allowfeed", 		do_allowfeed,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "allowembrace",	do_allowembrace,		POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "makebag", 		do_make_bag,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "wolfcall", 		do_wolf_call,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "hypnotize", 		do_hypnotize,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "vampfear", 		do_vampfear,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "stake", 		do_stake,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "removeactive",	do_removeactive,		POS_DEAD,	ML+1,	LOG_ALWAYS, 	1 },
	{ "history", 		do_history,			POS_DEAD,	0,	LOG_NORMAL, 	1 },
	{ "omni",		do_omni,			POS_DEAD,	L4,	LOG_NORMAL, 	1 },
	{ "hlook",		do_hlook,			POS_DEAD,	0,	LOG_NORMAL, 	1 },
	{ "altshort",		do_wereshort,			POS_DEAD,	ML+1,	LOG_NORMAL, 	1 },	
	{ "altdescription",	do_wolfdesc,			POS_DEAD,	0,	LOG_NORMAL, 	1 },
	{ "decapitate",		do_decapitate,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "triwield",		do_triwield,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "quadwield",		do_quadwield,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "induct",		do_patron,			POS_DEAD,	92,	LOG_NORMAL, 	1 },	
	{ "heretic",		do_heretic,			POS_DEAD,	92,	LOG_NORMAL, 	1 },	
	{ "offering", 		do_offering,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "shrine",		do_shrine,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "mtsteal",		do_mtsteal,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "use",		do_use,				POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "mindspeak",		do_mindspeak,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "randtest",		do_randtest,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },	
	{ "relogin",		do_relogin,			POS_RESTING,	6,	LOG_ALWAYS, 	1 },	
	{ "accuse",		do_accuse,			POS_RESTING,	1,	LOG_ALWAYS, 	1 },
	{ "stockade",		do_stockade,			POS_RESTING,	98,	LOG_ALWAYS, 	1 },
	{ "cloak",		do_cloak,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "breathe",		do_breath,			POS_FIGHTING,	0,	LOG_NORMAL, 	1 },
	{ "eyepower",		do_eyepower,			POS_FIGHTING,	0,	LOG_NORMAL, 	1 },
	{ "power",		do_power,			POS_FIGHTING,	0,	LOG_NORMAL, 	1 },
	{ "crecall", 		do_clanrecall,			POS_FIGHTING,	0,	LOG_NORMAL, 	1 },
	{ "hrecall",		do_homerecall,			POS_FIGHTING,	0,	LOG_NORMAL, 	1 },
   	{ "tail",		do_tail,			POS_FIGHTING,	0,	LOG_NORMAL, 	1 },
 	{ "award", 		do_award,			POS_DEAD,	L4, LOG_ALWAYS,		1 },
   	{ "nuke",		do_nuke,			POS_DEAD,	ML,  LOG_ALWAYS, 1 },
 	{ "pretitle",		do_pretitle,			POS_DEAD,		ML, 	LOG_ALWAYS,		1 },
	{ "restring", 		do_restring,			POS_DEAD,		20,	LOG_ALWAYS,		1 },
 	{ "wpeace",		do_wpeace,			POS_DEAD,		L4,	LOG_ALWAYS, 	1 },
 	{ "topcrime",		do_topcrime,			POS_DEAD,		1,	LOG_NEVER, 	1 },
 	{ "toparena",		do_toparena,			POS_DEAD,		1,	LOG_NEVER, 	1 },
	{ "pwipe",		do_pwipe,			POS_DEAD,		ML,	LOG_ALWAYS, 	1 },
 	{ "jobs",		do_quest,			POS_STANDING,		1,	LOG_NEVER, 	1 },
	{ "vampclan",		do_vampclan,			POS_DEAD,		ML,	LOG_ALWAYS, 	1 },
	{ "fangs",		do_fangs,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "vampclaw",		do_claws,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "poison",		do_poison,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "nightsight",		do_nightsight,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "mask",		do_mask,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "mortal",		do_mortal,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "darkheart",		do_darkheart,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "truesight",		do_truesight,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "scry",		do_scry,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "journey",		do_journey,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "shadowplane",	do_shadowplane,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "shadowsight",	do_shadowsight,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "favor",		do_favor,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "makedoll",		do_makedoll,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "voodoo",		do_voodoo,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "torpor",		do_torpor,			POS_STANDING,	91,	LOG_NORMAL, 	1 },
	{ "shapeshift", 	do_shapeshift,			POS_STANDING,	91,	LOG_NORMAL, 	1 },
	{ "highlander",		do_highlander,			POS_STANDING,	10,	LOG_NORMAL, 	1 },
	{ "buzz",		do_buzz,			POS_RESTING,	10,	LOG_NORMAL, 	1 },
	{ "justicar",		do_guard,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "laws",		do_laws,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "wishgrant",		do_wishgrant,			POS_DEAD,	100,	LOG_NORMAL, 	1 },	
	{ "quazer",		do_quazer,			POS_DEAD,	100,	LOG_NORMAL, 	1 },	
	{ "event",		do_event,			POS_DEAD,	100,	LOG_ALWAYS, 	1 },	
	{ "fealty",		do_fealty,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "knight",		do_knight,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "entitle",		do_entitle,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "squire",		do_squire,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "sendletter",		do_sendletter,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "pigeonlist",		do_pigeonlist,			POS_DEAD,	100,	LOG_NORMAL, 	1 },
	{ "pigeonremove",	do_pigeonremove,		POS_DEAD,	100,	LOG_NORMAL, 	1 },
	{ "checkletter",	do_checkletter,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "qdraw",	 	do_qdraw,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "fire", 		do_fire,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "pregnant",		do_pregnant,			POS_DEAD,	100,	LOG_NORMAL, 	1 },
	{ "preggo",		do_pregnant,			POS_DEAD,	100,	LOG_NORMAL, 	1 },
	{ "connect", 		do_connect,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "board", 		do_board,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "drive", 		do_drive,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "sail", 		do_drive,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "impslay",		do_impslay,			POS_DEAD,	100,	LOG_NORMAL, 	1 },
	{ "vehiclelist",	do_vehiclelist,			POS_DEAD,	100,	LOG_NORMAL, 	1 },
	{ "vehicleadd",		do_vehicle_add,			POS_DEAD,	100,	LOG_NORMAL, 	1 },
	{ "vehicledelete",	do_vehicle_delete,		POS_DEAD,	100,	LOG_NORMAL, 	1 },
	{ "kennel", 		do_kennel,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "pet", 		do_pet,				POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "mine", 		do_mine,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "smithweapon",	do_smithweapon,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "smitharmor",		do_smitharmor,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "repairarmor", 	do_repair_armor,		POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "repairweapon",	do_repair_weapon,		POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "skinhide",		do_skinhide,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "leathercraft",	do_leathercraft,		POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "price",		do_price,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "superboon",		do_superboon,			POS_DEAD,	100, 	LOG_ALWAYS,	1 },
	{ "voteclan",		do_voteclan,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "foundclan",		do_foundclan,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "whoclan",		do_whoclan,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "rankclan",		do_rankclan,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "disbandclan",	do_disbandclan,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "createnewpc",	do_createnewpc,			POS_RESTING,	0,	LOG_ALWAYS, 	1 },	
	{ "gmote",		do_gmote,			POS_RESTING,	97,	LOG_ALWAYS, 	1 },	
	{ "scatter",		do_scatter,			POS_DEAD,	L1,	LOG_ALWAYS, 	1 },
	{ "runictest",		update_runic,			POS_DEAD,	100,	LOG_ALWAYS, 	1 },
	{ "dreamtest",		do_dreamtest,			POS_DEAD,	100,	LOG_ALWAYS, 	1 },
	{ "songrecite",		do_songrecite,			POS_STANDING,	100,	LOG_NORMAL, 	1 },
	{ "songcraft",		do_songcraft,			POS_STANDING,	100,	LOG_NORMAL, 	1 },
	{ "disallowsongs",	do_disallowsongs,		POS_STANDING,	100,	LOG_NORMAL, 	1 },
	{ "shutup",		do_shutup,			POS_STANDING,	100,	LOG_NORMAL, 	1 },
	{ "posmote",		do_posmote,			POS_STANDING,	6,	LOG_NORMAL, 	1 },
	{ "shoot", 		do_shoot,			POS_STANDING,	1,	LOG_NORMAL, 	1 },
	{ "reload", 		do_reload,			POS_RESTING,	1,	LOG_NORMAL, 	1 },
    	{ "stargate",           do_stargate,                    POS_STANDING,   1,      LOG_NORMAL,     1 },
    	{ "gate",               do_stargate,                    POS_STANDING,   1,      LOG_NORMAL,     1 },
	{ "mountable", 	 	do_mountable,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "buck", 		do_buck,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "ignore", 		do_ignore,			POS_DEAD,	6,	LOG_NORMAL, 	1 },
	{ "antimagiceye",	do_antimagiceye,		POS_DEAD,	0,	LOG_NORMAL, 	1 },
...
/* PC Letgain Commands */
	...
	{ "pcletgainer",			do_pcletgainer,		POS_DEAD,	100, 	LOG_ALWAYS,	1 },
	{ "pcshort",				do_pcshort,				POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "pcdeclineletgain",	do_pcdeclineletgain,	POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "pcoffletgain",			do_pcofflineletgain,	POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "pclistletgain",		do_pclistletgains,	POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "pcunletgain",			do_pcunletgain,		POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "pcletgain",				do_pcletgain,			POS_STANDING,	0,	LOG_NORMAL, 	1 },
	...
	{ "holycast",		do_holycast,		POS_DEAD,		IM,	LOG_NORMAL,		1 },
	...
	{ "purgearea",		do_purgearea,			POS_DEAD,		L4,	LOG_ALWAYS,		1 },
...
//	{ "pipe",			do_pipe,			POS_DEAD,	ADMIN,	LOG_ALWAYS,		0 },
	...
	{ "weaponsmith",	do_weaponsmith,		POS_DEAD,	ADMIN,  LOG_ALWAYS,		1 },		
	{ "materialcheck",	do_materialcheck,	POS_DEAD,	COUNCIL,LOG_ALWAYS,		1 },
	...
	{ "reremort", 		do_reremort,			POS_DEAD,	100,		LOG_ALWAYS,		1 },
	...
	{ "tedit",			do_tedit,			POS_DEAD,	COUNCIL,LOG_ALWAYS,		1 },
	...
	{ "saveterritorydb",	do_saveterritory, 	POS_DEAD,	ML-1,	LOG_ALWAYS,		1 },
...
void interpret( char_data *ch, char *argument )
{
	...
	if ( !IS_IMMORTAL( ch ))
	{
		...
		if ( !IS_SET( cmd_table[cmd].flags, CMD_CRAFT)
			&& ch->desc
		...
		if ( IS_SET( cmd_table[cmd].flags, CMD_NO_HOLDPERSON )
			&& is_affected( ch, gsn_hold_person)) {
			ch->println("You can't do this while immobilized.");
			return;
		}
			...
			&& IS_AFFECTED2( ch, AFF2_STOCKADE)) 
		{
	 	...
	 	if ( IS_SET( cmd_table[cmd].flags, CMD_NO_WEREWOLF )
		     &&( (ch->race == race_lookup("werewolf")) || 
 			 (ch->race == race_lookup("werewolf-helf")) ||
 	 		 (ch->race == race_lookup("werewolf-elf")) ||
			 (ch->race == race_lookup("werewolf-s")) ||
 			 (ch->race == race_lookup("werewolf-d")) ||
	 		 (ch->race == race_lookup("werewolf-m")) ||
 			 (ch->race == race_lookup("werewolf-a")) ||
 			 (ch->race == race_lookup("werewolf-i")) ||
	 		 (ch->race == race_lookup("werewolf-c")) ) )
		{
 			ch->printlnf( "Not while you are a werewolf." );
 			return;
        	}

	 	if ( IS_SET( cmd_table[cmd].flags, CMD_NO_VAMPFORM )
		    && ( IS_NPC(ch) && IS_VAMPIRE(ch)) )
		{
 			ch->printlnf( "Not while in this form." );
 			return;
        	}

	 	if ( IS_SET( cmd_table[cmd].flags, CMD_NO_SHADOWPLANE )
			&& IS_AFFECTED2( ch, AFF2_SHADOWPLANE)) 
		{
 			ch->printlnf( "Not while shadowplaned." );
 			return;
        	}

...
DECLARE_SPELL_FUN( spell_spiritual_champion );
DECLARE_SPELL_FUN( spell_cupcake_breath		); // Ixliam
DECLARE_SPELL_FUN( spell_light_bonding		);
DECLARE_SPELL_FUN( spell_bonding			);
DECLARE_SPELL_FUN( spell_heavy_bonding		);
DECLARE_SPELL_FUN( spell_heavy_withering	);
DECLARE_SPELL_FUN( spell_light_withering	);
DECLARE_SPELL_FUN( spell_withering			);
DECLARE_SPELL_FUN( spell_destroy_living		);
